...
#define REQUIEM_ERROR_SOURCE_DEFAULT REQUIEM_ERROR_SOURCE_IDMEF_TREE_WRAP
...
static int requiem_string_copy(const requiem_string_t *src, requiem_string_t *dst)
{
        ...
        if ( ! requiem_string_is_empty(src) )
               return requiem_string_copy_dup(src, dst);
...
static int get_value_from_string(idmef_value_t **value, requiem_string_t *str, requiem_bool_t is_ptr)
{
        int ret;
        ...
        if ( ! is_ptr ) {
                ret = requiem_string_clone(str, &str);
                if ( ret < 0 )
                        return ret;
        }
...
static int get_value_from_data(idmef_value_t **value, idmef_data_t *data, requiem_bool_t is_ptr)
{
        int ret;
...
static int get_value_from_time(idmef_value_t **value, idmef_time_t *time, requiem_bool_t is_ptr)
{
        int ret;
...
static void list_insert(requiem_list_t *head, requiem_list_t *item, int pos)
{
        int i = 0;
        requiem_list_t *tmp;

        if ( pos == IDMEF_LIST_APPEND )
                requiem_list_add_tail(head, item);

        else if ( pos == IDMEF_LIST_PREPEND )
                requiem_list_add(head, item);
                ...
                requiem_list_add_tail(tmp, item);
        }
                ...
                requiem_list_for_each_reversed(head, tmp) {
                        if ( i == pos )
                                break;
                        i++;
                }

                requiem_list_add(tmp, item);
        }
}
...
idmef_additional_data_type_t idmef_additional_data_type_to_numeric(const char *name)
{
        ...
        return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_ENUM_STRING, "Unknown enumeration value '%s' for additional_data_type", name);
}
...
idmef_reference_origin_t idmef_reference_origin_to_numeric(const char *name)
{
        ...
        return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_ENUM_STRING, "Unknown enumeration value '%s' for reference_origin", name);
}
...
idmef_user_id_type_t idmef_user_id_type_to_numeric(const char *name)
{
        ...
        return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_ENUM_STRING, "Unknown enumeration value '%s' for user_id_type", name);
}
...
idmef_user_category_t idmef_user_category_to_numeric(const char *name)
{
        ...
        return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_ENUM_STRING, "Unknown enumeration value '%s' for user_category", name);
}
...
idmef_address_category_t idmef_address_category_to_numeric(const char *name)
{
        ...
        return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_ENUM_STRING, "Unknown enumeration value '%s' for address_category", name);
}
...
idmef_service_type_t idmef_service_type_to_numeric(const char *name)
{
        ...
        return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_ENUM_STRING, "Unknown enumeration value '%s' for service_type", name);
}
...
idmef_node_category_t idmef_node_category_to_numeric(const char *name)
{
        ...
        return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_ENUM_STRING, "Unknown enumeration value '%s' for node_category", name);
}
...
idmef_source_spoofed_t idmef_source_spoofed_to_numeric(const char *name)
{
        ...
        return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_ENUM_STRING, "Unknown enumeration value '%s' for source_spoofed", name);
}
...
idmef_checksum_algorithm_t idmef_checksum_algorithm_to_numeric(const char *name)
{
        ...
        return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_ENUM_STRING, "Unknown enumeration value '%s' for checksum_algorithm", name);
}
...
idmef_file_category_t idmef_file_category_to_numeric(const char *name)
{
        ...
        return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_ENUM_STRING, "Unknown enumeration value '%s' for file_category", name);
}
...
idmef_file_fstype_t idmef_file_fstype_to_numeric(const char *name)
{
        ...
        return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_ENUM_STRING, "Unknown enumeration value '%s' for file_fstype", name);
}
...
idmef_linkage_category_t idmef_linkage_category_to_numeric(const char *name)
{
        ...
        return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_ENUM_STRING, "Unknown enumeration value '%s' for linkage_category", name);
}
...
idmef_target_decoy_t idmef_target_decoy_to_numeric(const char *name)
{
        ...
        return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_ENUM_STRING, "Unknown enumeration value '%s' for target_decoy", name);
}
...
idmef_impact_severity_t idmef_impact_severity_to_numeric(const char *name)
{
        ...
        return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_ENUM_STRING, "Unknown enumeration value '%s' for impact_severity", name);
}
...
idmef_impact_completion_t idmef_impact_completion_to_numeric(const char *name)
{
        ...
        return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_ENUM_STRING, "Unknown enumeration value '%s' for impact_completion", name);
}
...
idmef_impact_type_t idmef_impact_type_to_numeric(const char *name)
{
        ...
        return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_ENUM_STRING, "Unknown enumeration value '%s' for impact_type", name);
}
...
idmef_action_category_t idmef_action_category_to_numeric(const char *name)
{
        ...
        return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_ENUM_STRING, "Unknown enumeration value '%s' for action_category", name);
}
...
idmef_confidence_rating_t idmef_confidence_rating_to_numeric(const char *name)
{
        ...
        return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_ENUM_STRING, "Unknown enumeration value '%s' for confidence_rating", name);
}
...
idmef_alert_type_t idmef_alert_type_to_numeric(const char *name)
{
        ...
        return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_ENUM_STRING, "Unknown enumeration value '%s' for alert_type", name);
}
...
idmef_message_type_t idmef_message_type_to_numeric(const char *name)
{
        ...
        return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_ENUM_STRING, "Unknown enumeration value '%s' for message_type", name);
}
...
{
        requiem_return_val_if_fail(additional_data, NULL);
...
int _idmef_additional_data_get_child(void *p, idmef_class_child_id_t child, void **childptr)
{
        ...
        requiem_return_val_if_fail(p, requiem_error(REQUIEM_ERROR_ASSERTION));
        *childptr = NULL;
        ...
        switch ( child ) {
                ...
                default:
                        return requiem_error(REQUIEM_ERROR_IDMEF_CLASS_UNKNOWN_CHILD);
        }
}
...
int _idmef_additional_data_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 1:
                        return idmef_additional_data_new_meaning(ptr, (requiem_string_t **) ret);
...
int _idmef_additional_data_destroy_child(void *p, idmef_class_child_id_t child, int n)
{
        ...
        switch ( child ) {
                ...
                case 1:
                        if ( ptr->meaning ) {
                                requiem_string_destroy(ptr->meaning);
                                ptr->meaning = NULL;
                        }
...
static void idmef_additional_data_destroy_internal(idmef_additional_data_t *ptr)
{
       ...
       if ( ! requiem_list_is_empty(&ptr->list) )
               requiem_list_del_init(&ptr->list);
...
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 *
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_additional_data_get_meaning(idmef_additional_data_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_additional_data_t object.
 * @meaning: pointer to a #requiem_string_t object.
 *
...
void idmef_additional_data_set_meaning(idmef_additional_data_t *ptr, requiem_string_t *meaning)
{
        requiem_return_if_fail(ptr);
 ...
 * @ptr: pointer to a #idmef_additional_data_t object.
 * @ret: pointer to an address where to store the created #requiem_string_t object.
 *
 * Create a new meaning object, children of #idmef_additional_data_t.
 * If @ptr already contain a #requiem_string_t object, then it is destroyed.
 *
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_additional_data_new_meaning(idmef_additional_data_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->meaning ) {
                retval = requiem_string_new(&ptr->meaning);
                if ( retval < 0 )
                        return retval;
        }
...
int idmef_additional_data_copy(const idmef_additional_data_t *src, idmef_additional_data_t *dst)
{
        ...
        if ( src->meaning ) {
                ret = requiem_string_clone(src->meaning, &dst->meaning);
                if ( ret < 0 )
                        return ret;
        }
...
int idmef_additional_data_compare(const idmef_additional_data_t *obj1, const idmef_additional_data_t *obj2)
{
        ...
        ret = requiem_string_compare(obj1->meaning, obj2->meaning);
        if ( ret != 0 )
                return ret;
...
int idmef_reference_new(idmef_reference_t **ret)
{
        *ret = calloc(1, sizeof(**ret));
        ...
        {
                int retval = requiem_string_new(&(*ret)->name);
        ...
        {
                int retval = requiem_string_new(&(*ret)->url);
...
{
        requiem_return_val_if_fail(reference, NULL);
        reference->refcount++;
...
int _idmef_reference_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 1:
                        return idmef_reference_new_name(ptr, (requiem_string_t **) ret);

                case 2:
                        return idmef_reference_new_url(ptr, (requiem_string_t **) ret);

                case 3:
                        return idmef_reference_new_meaning(ptr, (requiem_string_t **) ret);
...
int _idmef_reference_destroy_child(void *p, idmef_class_child_id_t child, int n)
{
        ...
        switch ( child ) {
                ...
                case 1:
                        if ( ptr->name ) {
                                requiem_string_destroy(ptr->name);
                                ptr->name = NULL;
                        }
                ...
                case 2:
                        if ( ptr->url ) {
                                requiem_string_destroy(ptr->url);
                                ptr->url = NULL;
                        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_reference_get_name(idmef_reference_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_reference_t object.
 * @name: pointer to a #requiem_string_t object.
 *
...
void idmef_reference_set_name(idmef_reference_t *ptr, requiem_string_t *name)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_reference_new_name(idmef_reference_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->name ) {
                retval = requiem_string_new(&ptr->name);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_reference_get_url(idmef_reference_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_reference_t object.
 * @url: pointer to a #requiem_string_t object.
 *
...
void idmef_reference_set_url(idmef_reference_t *ptr, requiem_string_t *url)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_reference_new_url(idmef_reference_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->url ) {
                retval = requiem_string_new(&ptr->url);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_reference_get_meaning(idmef_reference_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_reference_set_meaning(idmef_reference_t *ptr, requiem_string_t *meaning)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_reference_new_meaning(idmef_reference_t *ptr, requiem_string_t **ret)
{
        int retval;
...
int idmef_reference_copy(const idmef_reference_t *src, idmef_reference_t *dst)
{
        ...
        if ( src->name ) {
                ret = requiem_string_copy(src->name, dst->name);
                if ( ret < 0 )
                        return ret;
        }

        if ( src->url ) {
                ret = requiem_string_copy(src->url, dst->url);
                if ( ret < 0 )
                        return ret;
        }
...
int idmef_reference_compare(const idmef_reference_t *obj1, const idmef_reference_t *obj2)
{
        ...
        ret = requiem_string_compare(obj1->name, obj2->name);
        if ( ret != 0 )
                return ret;

        ret = requiem_string_compare(obj1->url, obj2->url);
        if ( ret != 0 )
                return ret;
...
int idmef_classification_new(idmef_classification_t **ret)
{
        *ret = calloc(1, sizeof(**ret));
        ...
        requiem_list_init(&(*ret)->reference_list);


        {
                int retval = requiem_string_new(&(*ret)->text);
...
{
        requiem_return_val_if_fail(classification, NULL);
...
int _idmef_classification_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        return idmef_classification_new_ident(ptr, (requiem_string_t **) ret);

                case 1:
                        return idmef_classification_new_text(ptr, (requiem_string_t **) ret);
                ...
                case 2: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->reference_list, tmp) {
                                       if ( i++ == n ) {
                                               *ret = requiem_list_entry(tmp, idmef_reference_t, list);
                                               return 0;
                                       }
                               }

                               if ( i != n )
                                       return requiem_error(REQUIEM_ERROR_IDMEF_TREE_INDEX_UNDEFINED);
                        } else {
                               int pos = (-n) - 1; /* With negative value, -1 is the base, translate to 0 */

                               requiem_list_for_each_reversed(&ptr->reference_list, tmp) {
                                       if ( i++ == pos ) {
                                               *ret = requiem_list_entry(tmp, idmef_reference_t, list);
                                               return 0;
                                       }
...
int _idmef_classification_destroy_child(void *p, idmef_class_child_id_t child, int n)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        if ( ptr->ident ) {
                                requiem_string_destroy(ptr->ident);
                                ptr->ident = NULL;
                        }
                ...
                case 1:
                        if ( ptr->text ) {
                                requiem_string_destroy(ptr->text);
                                ptr->text = NULL;
                        }
                ...
                case 2: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->reference_list, tmp) {
                                       if ( i++ == n ) {
                                               void *b = requiem_list_entry(tmp, idmef_reference_t, list);
...
static void idmef_classification_destroy_internal(idmef_classification_t *ptr)
{
        ...
        {
                requiem_list_t *n, *tmp;
                idmef_reference_t *entry;

                requiem_list_for_each_safe(&ptr->reference_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_reference_t, list);
                        requiem_list_del_init(&entry->list);
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_classification_get_ident(idmef_classification_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_classification_t object.
 * @ident: pointer to a #requiem_string_t object.
 *
...
void idmef_classification_set_ident(idmef_classification_t *ptr, requiem_string_t *ident)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_classification_new_ident(idmef_classification_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->ident ) {
                retval = requiem_string_new(&ptr->ident);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_classification_get_text(idmef_classification_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_classification_t object.
 * @text: pointer to a #requiem_string_t object.
 *
...
void idmef_classification_set_text(idmef_classification_t *ptr, requiem_string_t *text)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_classification_new_text(idmef_classification_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->text ) {
                retval = requiem_string_new(&ptr->text);
                if ( retval < 0 )
                        return retval;
        }
...
{
        requiem_list_t *tmp = (reference_cur) ? &reference_cur->list : NULL;

        requiem_return_val_if_fail(classification, NULL);

        requiem_list_for_each_continue(&classification->reference_list, tmp)
                return requiem_list_entry(tmp, idmef_reference_t, list);
...
{
        requiem_return_if_fail(ptr);
        requiem_return_if_fail(object);

        if ( ! requiem_list_is_empty(&object->list) )
                requiem_list_del_init(&object->list);
...
int idmef_classification_copy(const idmef_classification_t *src, idmef_classification_t *dst)
{
        ...
        if ( src->ident ) {
                ret = requiem_string_clone(src->ident, &dst->ident);
                if ( ret < 0 )
                        return ret;
        }

        if ( src->text ) {
                ret = requiem_string_copy(src->text, dst->text);
                if ( ret < 0 )
                        return ret;
        }

        {
                ...
                requiem_list_for_each_safe(&src->reference_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_reference_t, list);
                        idmef_reference_clone(entry, &new);
                        requiem_list_add_tail(&dst->reference_list, &new->list);
                }
        }
...
int idmef_classification_compare(const idmef_classification_t *obj1, const idmef_classification_t *obj2)
{
        ...
        ret = requiem_string_compare(obj1->ident, obj2->ident);
        if ( ret != 0 )
                return ret;

        ret = requiem_string_compare(obj1->text, obj2->text);
        if ( ret != 0 )
                return ret;

        {
                requiem_list_t *tmp1, *tmp2;
                ...
                do {
                        ...
                        requiem_list_for_each_continue(&obj1->reference_list, tmp1) {
                                entry1 = requiem_list_entry(tmp1, idmef_reference_t, list);
                                break;
                        }

                        requiem_list_for_each_continue(&obj2->reference_list, tmp2) {
                                entry2 = requiem_list_entry(tmp2, idmef_reference_t, list);
                                break;
                        }
...
{
        requiem_return_val_if_fail(user_id, NULL);
        user_id->refcount++;
...
int _idmef_user_id_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        return idmef_user_id_new_ident(ptr, (requiem_string_t **) ret);

                case 1:
                        return idmef_user_id_new_type(ptr, (idmef_user_id_type_t **) ret);

                case 2:
                        return idmef_user_id_new_tty(ptr, (requiem_string_t **) ret);

                case 3:
                        return idmef_user_id_new_name(ptr, (requiem_string_t **) ret);
...
int _idmef_user_id_destroy_child(void *p, idmef_class_child_id_t child, int n)
{
        ...
        switch ( child ) {
                ...
                case 2:
                        if ( ptr->tty ) {
                                requiem_string_destroy(ptr->tty);
                                ptr->tty = NULL;
                        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_user_id_get_ident(idmef_user_id_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_user_id_set_ident(idmef_user_id_t *ptr, requiem_string_t *ident)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_user_id_new_ident(idmef_user_id_t *ptr, requiem_string_t **ret)
{
        int retval;
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_user_id_get_tty(idmef_user_id_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_user_id_t object.
 * @tty: pointer to a #requiem_string_t object.
 *
...
void idmef_user_id_set_tty(idmef_user_id_t *ptr, requiem_string_t *tty)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_user_id_new_tty(idmef_user_id_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->tty ) {
                retval = requiem_string_new(&ptr->tty);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_user_id_get_name(idmef_user_id_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_user_id_set_name(idmef_user_id_t *ptr, requiem_string_t *name)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_user_id_new_name(idmef_user_id_t *ptr, requiem_string_t **ret)
{
        int retval;
...
int idmef_user_id_copy(const idmef_user_id_t *src, idmef_user_id_t *dst)
{
        ...
        if ( src->tty ) {
                ret = requiem_string_clone(src->tty, &dst->tty);
                if ( ret < 0 )
                        return ret;
        }

        if ( src->name ) {
                ret = requiem_string_clone(src->name, &dst->name);
                if ( ret < 0 )
                        return ret;
        }
...
int idmef_user_id_compare(const idmef_user_id_t *obj1, const idmef_user_id_t *obj2)
{
        ...
        ret = requiem_string_compare(obj1->tty, obj2->tty);
        if ( ret != 0 )
                return ret;
...
int idmef_user_new(idmef_user_t **ret)
{
        *ret = calloc(1, sizeof(**ret));
        ...
        requiem_list_init(&(*ret)->user_id_list);
...
{
        requiem_return_val_if_fail(user, NULL);
        user->refcount++;
...
int _idmef_user_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        return idmef_user_new_ident(ptr, (requiem_string_t **) ret);
                ...
                case 2: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->user_id_list, tmp) {
                                       if ( i++ == n ) {
                                               *ret = requiem_list_entry(tmp, idmef_user_id_t, list);
                                               return 0;
                                       }
                               }
                               ...
                               requiem_list_for_each_reversed(&ptr->user_id_list, tmp) {
                                       if ( i++ == pos ) {
                                               *ret = requiem_list_entry(tmp, idmef_user_id_t, list);
                                               return 0;
                                       }
        ...
        switch ( child ) {
                ...
                case 2: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->user_id_list, tmp) {
                                       if ( i++ == n ) {
                                               void *b = requiem_list_entry(tmp, idmef_user_id_t, list);
...
static void idmef_user_destroy_internal(idmef_user_t *ptr)
{
...

        {
                ...
                requiem_list_for_each_safe(&ptr->user_id_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_user_id_t, list);
                        requiem_list_del_init(&entry->list);
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_user_get_ident(idmef_user_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_user_set_ident(idmef_user_t *ptr, requiem_string_t *ident)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_user_new_ident(idmef_user_t *ptr, requiem_string_t **ret)
{
        int retval;
...
{
        requiem_list_t *tmp = (user_id_cur) ? &user_id_cur->list : NULL;

        requiem_return_val_if_fail(user, NULL);

        requiem_list_for_each_continue(&user->user_id_list, tmp)
                return requiem_list_entry(tmp, idmef_user_id_t, list);
...
int idmef_user_copy(const idmef_user_t *src, idmef_user_t *dst)
{
...

        {
                ...
                requiem_list_for_each_safe(&src->user_id_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_user_id_t, list);
                        idmef_user_id_clone(entry, &new);
                        requiem_list_add_tail(&dst->user_id_list, &new->list);
                }
        }
...
int idmef_user_compare(const idmef_user_t *obj1, const idmef_user_t *obj2)
{
...

        {
                ...
                do {
                        ...
                        requiem_list_for_each_continue(&obj1->user_id_list, tmp1) {
                                entry1 = requiem_list_entry(tmp1, idmef_user_id_t, list);
                                break;
                        }

                        requiem_list_for_each_continue(&obj2->user_id_list, tmp2) {
                                entry2 = requiem_list_entry(tmp2, idmef_user_id_t, list);
                                break;
                        }
...
int idmef_address_new(idmef_address_t **ret)
{
        *ret = calloc(1, sizeof(**ret));
        ...
        {
                int retval = requiem_string_new(&(*ret)->address);
...
{
        requiem_return_val_if_fail(address, NULL);
        address->refcount++;
...
int _idmef_address_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        return idmef_address_new_ident(ptr, (requiem_string_t **) ret);

                case 1:
                        return idmef_address_new_category(ptr, (idmef_address_category_t **) ret);

                case 2:
                        return idmef_address_new_vlan_name(ptr, (requiem_string_t **) ret);

                case 3:
                        return idmef_address_new_vlan_num(ptr, (int32_t **) ret);

                case 4:
                        return idmef_address_new_address(ptr, (requiem_string_t **) ret);

                case 5:
                        return idmef_address_new_netmask(ptr, (requiem_string_t **) ret);
...
int _idmef_address_destroy_child(void *p, idmef_class_child_id_t child, int n)
{
        ...
        switch ( child ) {
                ...
                case 2:
                        if ( ptr->vlan_name ) {
                                requiem_string_destroy(ptr->vlan_name);
                                ptr->vlan_name = NULL;
                        }
                ...
                case 4:
                        if ( ptr->address ) {
                                requiem_string_destroy(ptr->address);
                                ptr->address = NULL;
                        }
                ...
                case 5:
                        if ( ptr->netmask ) {
                                requiem_string_destroy(ptr->netmask);
                                ptr->netmask = NULL;
                        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_address_get_ident(idmef_address_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_address_set_ident(idmef_address_t *ptr, requiem_string_t *ident)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_address_new_ident(idmef_address_t *ptr, requiem_string_t **ret)
{
        int retval;
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_address_get_vlan_name(idmef_address_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_address_t object.
 * @vlan_name: pointer to a #requiem_string_t object.
 *
...
void idmef_address_set_vlan_name(idmef_address_t *ptr, requiem_string_t *vlan_name)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_address_new_vlan_name(idmef_address_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->vlan_name ) {
                retval = requiem_string_new(&ptr->vlan_name);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_address_get_address(idmef_address_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_address_t object.
 * @address: pointer to a #requiem_string_t object.
 *
...
void idmef_address_set_address(idmef_address_t *ptr, requiem_string_t *address)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_address_new_address(idmef_address_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->address ) {
                retval = requiem_string_new(&ptr->address);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_address_get_netmask(idmef_address_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_address_t object.
 * @netmask: pointer to a #requiem_string_t object.
 *
...
void idmef_address_set_netmask(idmef_address_t *ptr, requiem_string_t *netmask)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_address_new_netmask(idmef_address_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->netmask ) {
                retval = requiem_string_new(&ptr->netmask);
                if ( retval < 0 )
                        return retval;
        }
...
int idmef_address_copy(const idmef_address_t *src, idmef_address_t *dst)
{
        ...
        if ( src->vlan_name ) {
                ret = requiem_string_clone(src->vlan_name, &dst->vlan_name);
                if ( ret < 0 )
                        return ret;
        }
        ...
        if ( src->address ) {
                ret = requiem_string_copy(src->address, dst->address);
                if ( ret < 0 )
                        return ret;
        }

        if ( src->netmask ) {
                ret = requiem_string_clone(src->netmask, &dst->netmask);
                if ( ret < 0 )
                        return ret;
        }
...
int idmef_address_compare(const idmef_address_t *obj1, const idmef_address_t *obj2)
{
        ...
        ret = requiem_string_compare(obj1->vlan_name, obj2->vlan_name);
        if ( ret != 0 )
                return ret;
        ...
        ret = requiem_string_compare(obj1->address, obj2->address);
        if ( ret != 0 )
                return ret;

        ret = requiem_string_compare(obj1->netmask, obj2->netmask);
        if ( ret != 0 )
                return ret;
...
int idmef_process_new(idmef_process_t **ret)
{
        *ret = calloc(1, sizeof(**ret));
        ...
        requiem_list_init(&(*ret)->arg_list);


        requiem_list_init(&(*ret)->env_list);
...
{
        requiem_return_val_if_fail(process, NULL);
        process->refcount++;
...
int _idmef_process_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        return idmef_process_new_ident(ptr, (requiem_string_t **) ret);

                case 1:
                        return idmef_process_new_name(ptr, (requiem_string_t **) ret);

                case 2:
                        return idmef_process_new_pid(ptr, (uint32_t **) ret);

                case 3:
                        return idmef_process_new_path(ptr, (requiem_string_t **) ret);
                ...
                case 4: {
                        ...
                        if ( n == IDMEF_LIST_APPEND || n == IDMEF_LIST_PREPEND )
                               return idmef_process_new_arg(ptr, (requiem_string_t **) ret, n);

                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->arg_list, tmp) {
                                       if ( i++ == n ) {
                                               *ret = requiem_list_entry(tmp, requiem_string_t, list);
                                               return 0;
                                       }
                               }
                               ...
                               requiem_list_for_each_reversed(&ptr->arg_list, tmp) {
                                       if ( i++ == pos ) {
                                               *ret = requiem_list_entry(tmp, requiem_string_t, list);
                                               return 0;
                                       }
                ...
                case 5: {
                        ...
                        if ( n == IDMEF_LIST_APPEND || n == IDMEF_LIST_PREPEND )
                               return idmef_process_new_env(ptr, (requiem_string_t **) ret, n);

                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->env_list, tmp) {
                                       if ( i++ == n ) {
                                               *ret = requiem_list_entry(tmp, requiem_string_t, list);
                                               return 0;
                                       }
                               ...
                               requiem_list_for_each_reversed(&ptr->env_list, tmp) {
                                       if ( i++ == pos ) {
                                               *ret = requiem_list_entry(tmp, requiem_string_t, list);
                                               return 0;
                                       }
...
int _idmef_process_destroy_child(void *p, idmef_class_child_id_t child, int n)
{
        ...
        switch ( child ) {
                ...
                case 3:
                        if ( ptr->path ) {
                                requiem_string_destroy(ptr->path);
                                ptr->path = NULL;
                        }
                ...
                case 4: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->arg_list, tmp) {
                                       if ( i++ == n ) {
                                               void *b = requiem_list_entry(tmp, requiem_string_t, list);
                                               requiem_string_destroy(b);
                                               return 0;
                                       }
                               }
...
static void idmef_process_destroy_internal(idmef_process_t *ptr)
{
        ...
        {
                requiem_list_t *n, *tmp;
                requiem_string_t *entry;

                requiem_list_for_each_safe(&ptr->arg_list, tmp, n) {
                        entry = requiem_list_entry(tmp, requiem_string_t, list);
                        requiem_list_del_init(&entry->list);
                        requiem_string_destroy(entry);
                }
        }

        {
                ...
                requiem_list_for_each_safe(&ptr->env_list, tmp, n) {
                        entry = requiem_list_entry(tmp, requiem_string_t, list);
                        requiem_list_del_init(&entry->list);
                        requiem_string_destroy(entry);
                }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_process_get_ident(idmef_process_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_process_set_ident(idmef_process_t *ptr, requiem_string_t *ident)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_process_new_ident(idmef_process_t *ptr, requiem_string_t **ret)
{
        int retval;
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_process_get_name(idmef_process_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_process_set_name(idmef_process_t *ptr, requiem_string_t *name)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_process_new_name(idmef_process_t *ptr, requiem_string_t **ret)
{
        int retval;
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_process_get_path(idmef_process_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_process_t object.
 * @path: pointer to a #requiem_string_t object.
 *
...
void idmef_process_set_path(idmef_process_t *ptr, requiem_string_t *path)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_process_new_path(idmef_process_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->path ) {
                retval = requiem_string_new(&ptr->path);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * @process: pointer to a #idmef_process_t object.
 * @requiem_string_cur: pointer to a #requiem_string_t object.
 *
 * Get the next #requiem_string_t object listed in @ptr.
 * When iterating over the requiem_string_t object listed in @ptr,
 * @object should be set to the latest returned #requiem_string_t object.
 *
 * Returns: the next #requiem_string_t in the list.
 */
requiem_string_t *idmef_process_get_next_arg(idmef_process_t *process, requiem_string_t *requiem_string_cur)
{
        requiem_list_t *tmp = (requiem_string_cur) ? &requiem_string_cur->list : NULL;

        requiem_return_val_if_fail(process, NULL);

        requiem_list_for_each_continue(&process->arg_list, tmp)
                return requiem_list_entry(tmp, requiem_string_t, list);
 ...
 * @ptr: pointer to a #idmef_process_t object.
 * @object: pointer to a #requiem_string_t object.
 * @pos: Position in the list.
 *
 * Add @object to position @pos of @ptr list of #requiem_string_t object.
 *
 * If @pos is #IDMEF_LIST_APPEND, @object will be inserted at the tail of the list.
 * If @pos is #IDMEF_LIST_PREPEND, @object will be inserted at the head of the list.
 */
void idmef_process_set_arg(idmef_process_t *ptr, requiem_string_t *object, int pos)
{
        requiem_return_if_fail(ptr);
        requiem_return_if_fail(object);
 ...
 * @pos: position in the list.
 *
 * Create a new #requiem_string_t children of @ptr, and add it to position @pos of
 * @ptr list of #requiem_string_t object. The created #requiem_string_t object is
 * stored in @ret.
 *
 * If @pos is #IDMEF_LIST_APPEND, @object will be inserted at the tail of the list.
 * If @pos is #IDMEF_LIST_PREPEND, @object will be inserted at the head of the list.
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_process_new_arg(idmef_process_t *ptr, requiem_string_t **ret, int pos)
{
        int retval;

        requiem_return_val_if_fail(ptr, requiem_error(REQUIEM_ERROR_ASSERTION));

        retval = requiem_string_new(ret);
        if ( retval < 0 )
                return retval;
 ...
 * Returns: the next #requiem_string_t in the list.
 */
requiem_string_t *idmef_process_get_next_env(idmef_process_t *process, requiem_string_t *requiem_string_cur)
{
        requiem_list_t *tmp = (requiem_string_cur) ? &requiem_string_cur->list : NULL;

        requiem_return_val_if_fail(process, NULL);

        requiem_list_for_each_continue(&process->env_list, tmp)
                return requiem_list_entry(tmp, requiem_string_t, list);
 ...
 * If @pos is #IDMEF_LIST_PREPEND, @object will be inserted at the head of the list.
 */
void idmef_process_set_env(idmef_process_t *ptr, requiem_string_t *object, int pos)
{
        requiem_return_if_fail(ptr);
        requiem_return_if_fail(object);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_process_new_env(idmef_process_t *ptr, requiem_string_t **ret, int pos)
{
        int retval;
...
int idmef_process_copy(const idmef_process_t *src, idmef_process_t *dst)
{
        ...
        if ( src->path ) {
                ret = requiem_string_clone(src->path, &dst->path);
                if ( ret < 0 )
                        return ret;
        }
        ...
        {
                requiem_list_t *n, *tmp;
                requiem_string_t *entry, *new;

                requiem_list_for_each_safe(&src->arg_list, tmp, n) {
                        entry = requiem_list_entry(tmp, requiem_string_t, list);
                        requiem_string_clone(entry, &new);
                        requiem_list_add_tail(&dst->arg_list, &new->list);
                }
        }

        {
                ...
                requiem_list_for_each_safe(&src->env_list, tmp, n) {
                        entry = requiem_list_entry(tmp, requiem_string_t, list);
                        requiem_string_clone(entry, &new);
                        requiem_list_add_tail(&dst->env_list, &new->list);
                }
        }
...
int idmef_process_compare(const idmef_process_t *obj1, const idmef_process_t *obj2)
{
        ...
        ret = requiem_string_compare(obj1->path, obj2->path);
        if ( ret != 0 )
                return ret;

        {
                requiem_list_t *tmp1, *tmp2;
                requiem_string_t *entry1, *entry2;

                tmp1 = tmp2 = NULL;
                do {
                        entry1 = entry2 = NULL;

                        requiem_list_for_each_continue(&obj1->arg_list, tmp1) {
                                entry1 = requiem_list_entry(tmp1, requiem_string_t, list);
                                break;
                        }

                        requiem_list_for_each_continue(&obj2->arg_list, tmp2) {
                                entry2 = requiem_list_entry(tmp2, requiem_string_t, list);
                                break;
                        }

                        ret = requiem_string_compare(entry1, entry2);
                        if ( ret != 0 )
                                return ret;
...

        {
                ...
                do {
                        ...
                        requiem_list_for_each_continue(&obj1->env_list, tmp1) {
                                entry1 = requiem_list_entry(tmp1, requiem_string_t, list);
                                break;
                        }

                        requiem_list_for_each_continue(&obj2->env_list, tmp2) {
                                entry2 = requiem_list_entry(tmp2, requiem_string_t, list);
                                break;
                        }
...
{
        requiem_return_val_if_fail(web_service, NULL);
...
int _idmef_web_service_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        return idmef_web_service_new_url(ptr, (requiem_string_t **) ret);

                case 1:
                        return idmef_web_service_new_cgi(ptr, (requiem_string_t **) ret);

                case 2:
                        return idmef_web_service_new_http_method(ptr, (requiem_string_t **) ret);
                ...
                case 3: {
                        ...
                        if ( n == IDMEF_LIST_APPEND || n == IDMEF_LIST_PREPEND )
                               return idmef_web_service_new_arg(ptr, (requiem_string_t **) ret, n);
...
int _idmef_web_service_destroy_child(void *p, idmef_class_child_id_t child, int n)
{
        ...
        switch ( child ) {
                ...
                case 1:
                        if ( ptr->cgi ) {
                                requiem_string_destroy(ptr->cgi);
                                ptr->cgi = NULL;
                        }
                ...
                case 2:
                        if ( ptr->http_method ) {
                                requiem_string_destroy(ptr->http_method);
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_web_service_get_url(idmef_web_service_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_web_service_set_url(idmef_web_service_t *ptr, requiem_string_t *url)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_web_service_new_url(idmef_web_service_t *ptr, requiem_string_t **ret)
{
        int retval;
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_web_service_get_cgi(idmef_web_service_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_web_service_t object.
 * @cgi: pointer to a #requiem_string_t object.
 *
...
void idmef_web_service_set_cgi(idmef_web_service_t *ptr, requiem_string_t *cgi)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_web_service_new_cgi(idmef_web_service_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->cgi ) {
                retval = requiem_string_new(&ptr->cgi);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_web_service_get_http_method(idmef_web_service_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_web_service_t object.
 * @http_method: pointer to a #requiem_string_t object.
 *
...
void idmef_web_service_set_http_method(idmef_web_service_t *ptr, requiem_string_t *http_method)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_web_service_new_http_method(idmef_web_service_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->http_method ) {
                retval = requiem_string_new(&ptr->http_method);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: the next #requiem_string_t in the list.
 */
requiem_string_t *idmef_web_service_get_next_arg(idmef_web_service_t *web_service, requiem_string_t *requiem_string_cur)
{
        requiem_list_t *tmp = (requiem_string_cur) ? &requiem_string_cur->list : NULL;

        requiem_return_val_if_fail(web_service, NULL);

        requiem_list_for_each_continue(&web_service->arg_list, tmp)
                return requiem_list_entry(tmp, requiem_string_t, list);
 ...
 * If @pos is #IDMEF_LIST_PREPEND, @object will be inserted at the head of the list.
 */
void idmef_web_service_set_arg(idmef_web_service_t *ptr, requiem_string_t *object, int pos)
{
        requiem_return_if_fail(ptr);
        requiem_return_if_fail(object);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_web_service_new_arg(idmef_web_service_t *ptr, requiem_string_t **ret, int pos)
{
        int retval;
...
int idmef_web_service_copy(const idmef_web_service_t *src, idmef_web_service_t *dst)
{
        ...
        if ( src->cgi ) {
                ret = requiem_string_clone(src->cgi, &dst->cgi);
                if ( ret < 0 )
                        return ret;
        }

        if ( src->http_method ) {
                ret = requiem_string_clone(src->http_method, &dst->http_method);
                if ( ret < 0 )
                        return ret;
        }
...
int idmef_web_service_compare(const idmef_web_service_t *obj1, const idmef_web_service_t *obj2)
{
        ...
        ret = requiem_string_compare(obj1->cgi, obj2->cgi);
        if ( ret != 0 )
                return ret;

        ret = requiem_string_compare(obj1->http_method, obj2->http_method);
        if ( ret != 0 )
                return ret;
...
{
        requiem_return_val_if_fail(snmp_service, NULL);
...
int _idmef_snmp_service_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        return idmef_snmp_service_new_oid(ptr, (requiem_string_t **) ret);
                ...
                case 3:
                        return idmef_snmp_service_new_security_name(ptr, (requiem_string_t **) ret);

                case 4:
                        return idmef_snmp_service_new_security_level(ptr, (uint32_t **) ret);

                case 5:
                        return idmef_snmp_service_new_context_name(ptr, (requiem_string_t **) ret);

                case 6:
                        return idmef_snmp_service_new_context_engine_id(ptr, (requiem_string_t **) ret);

                case 7:
                        return idmef_snmp_service_new_command(ptr, (requiem_string_t **) ret);

                case 8:
                        return idmef_snmp_service_new_community(ptr, (requiem_string_t **) ret);
...
int _idmef_snmp_service_destroy_child(void *p, idmef_class_child_id_t child, int n)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        if ( ptr->oid ) {
                                requiem_string_destroy(ptr->oid);
                                ptr->oid = NULL;
                        }
                ...
                case 3:
                        if ( ptr->security_name ) {
                                requiem_string_destroy(ptr->security_name);
                ...
                case 5:
                        if ( ptr->context_name ) {
                                requiem_string_destroy(ptr->context_name);
                ...
                case 6:
                        if ( ptr->context_engine_id ) {
                                requiem_string_destroy(ptr->context_engine_id);
                ...
                case 7:
                        if ( ptr->command ) {
                                requiem_string_destroy(ptr->command);
                                ptr->command = NULL;
                        }
                ...
                case 8:
                        if ( ptr->community ) {
                                requiem_string_destroy(ptr->community);
                                ptr->community = NULL;
                        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_snmp_service_get_oid(idmef_snmp_service_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_snmp_service_t object.
 * @oid: pointer to a #requiem_string_t object.
 *
...
void idmef_snmp_service_set_oid(idmef_snmp_service_t *ptr, requiem_string_t *oid)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_snmp_service_new_oid(idmef_snmp_service_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->oid ) {
                retval = requiem_string_new(&ptr->oid);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_snmp_service_get_security_name(idmef_snmp_service_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_snmp_service_t object.
 * @security_name: pointer to a #requiem_string_t object.
 *
...
void idmef_snmp_service_set_security_name(idmef_snmp_service_t *ptr, requiem_string_t *security_name)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_snmp_service_new_security_name(idmef_snmp_service_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->security_name ) {
                retval = requiem_string_new(&ptr->security_name);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_snmp_service_get_context_name(idmef_snmp_service_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_snmp_service_t object.
 * @context_name: pointer to a #requiem_string_t object.
 *
...
void idmef_snmp_service_set_context_name(idmef_snmp_service_t *ptr, requiem_string_t *context_name)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_snmp_service_new_context_name(idmef_snmp_service_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->context_name ) {
                retval = requiem_string_new(&ptr->context_name);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_snmp_service_get_context_engine_id(idmef_snmp_service_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_snmp_service_t object.
 * @context_engine_id: pointer to a #requiem_string_t object.
 *
...
void idmef_snmp_service_set_context_engine_id(idmef_snmp_service_t *ptr, requiem_string_t *context_engine_id)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_snmp_service_new_context_engine_id(idmef_snmp_service_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->context_engine_id ) {
                retval = requiem_string_new(&ptr->context_engine_id);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_snmp_service_get_command(idmef_snmp_service_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_snmp_service_t object.
 * @command: pointer to a #requiem_string_t object.
 *
...
void idmef_snmp_service_set_command(idmef_snmp_service_t *ptr, requiem_string_t *command)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_snmp_service_new_command(idmef_snmp_service_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->command ) {
                retval = requiem_string_new(&ptr->command);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_snmp_service_get_community(idmef_snmp_service_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_snmp_service_t object.
 * @community: pointer to a #requiem_string_t object.
 *
...
void idmef_snmp_service_set_community(idmef_snmp_service_t *ptr, requiem_string_t *community)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_snmp_service_new_community(idmef_snmp_service_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->community ) {
                retval = requiem_string_new(&ptr->community);
                if ( retval < 0 )
                        return retval;
        }
...
int idmef_snmp_service_copy(const idmef_snmp_service_t *src, idmef_snmp_service_t *dst)
{
        ...
        if ( src->oid ) {
                ret = requiem_string_clone(src->oid, &dst->oid);
                if ( ret < 0 )
                        return ret;
        }
        ...
        if ( src->security_name ) {
                ret = requiem_string_clone(src->security_name, &dst->security_name);
                if ( ret < 0 )
                        return ret;
        }
        ...
        if ( src->context_name ) {
                ret = requiem_string_clone(src->context_name, &dst->context_name);
                if ( ret < 0 )
                        return ret;
        }

        if ( src->context_engine_id ) {
                ret = requiem_string_clone(src->context_engine_id, &dst->context_engine_id);
                if ( ret < 0 )
                        return ret;
        }

        if ( src->command ) {
                ret = requiem_string_clone(src->command, &dst->command);
                if ( ret < 0 )
                        return ret;
        }

        if ( src->community ) {
                ret = requiem_string_clone(src->community, &dst->community);
                if ( ret < 0 )
                        return ret;
        }
...
int idmef_snmp_service_compare(const idmef_snmp_service_t *obj1, const idmef_snmp_service_t *obj2)
{
        ...
        ret = requiem_string_compare(obj1->oid, obj2->oid);
        if ( ret != 0 )
                return ret;
        ...
        ret = requiem_string_compare(obj1->security_name, obj2->security_name);
        if ( ret != 0 )
                return ret;
        ...
        ret = requiem_string_compare(obj1->context_name, obj2->context_name);
        if ( ret != 0 )
                return ret;

        ret = requiem_string_compare(obj1->context_engine_id, obj2->context_engine_id);
        if ( ret != 0 )
                return ret;

        ret = requiem_string_compare(obj1->command, obj2->command);
        if ( ret != 0 )
                return ret;

        ret = requiem_string_compare(obj1->community, obj2->community);
        if ( ret != 0 )
                return ret;
...
{
        requiem_return_val_if_fail(service, NULL);
        service->refcount++;
...
int _idmef_service_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        return idmef_service_new_ident(ptr, (requiem_string_t **) ret);
                ...
                case 3:
                        return idmef_service_new_iana_protocol_name(ptr, (requiem_string_t **) ret);

                case 4:
                        return idmef_service_new_name(ptr, (requiem_string_t **) ret);

                case 5:
                        return idmef_service_new_port(ptr, (uint16_t **) ret);

                case 6:
                        return idmef_service_new_portlist(ptr, (requiem_string_t **) ret);

                case 7:
                        return idmef_service_new_protocol(ptr, (requiem_string_t **) ret);
        ...
        switch ( child ) {
                ...
                case 3:
                        if ( ptr->iana_protocol_name ) {
                                requiem_string_destroy(ptr->iana_protocol_name);
                ...
                case 6:
                        if ( ptr->portlist ) {
                                requiem_string_destroy(ptr->portlist);
                                ptr->portlist = NULL;
                        }
                ...
                case 7:
                        if ( ptr->protocol ) {
                                requiem_string_destroy(ptr->protocol);
                                ptr->protocol = NULL;
                        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_service_get_ident(idmef_service_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_service_set_ident(idmef_service_t *ptr, requiem_string_t *ident)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_service_new_ident(idmef_service_t *ptr, requiem_string_t **ret)
{
        int retval;
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_service_get_iana_protocol_name(idmef_service_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_service_t object.
 * @iana_protocol_name: pointer to a #requiem_string_t object.
 *
...
void idmef_service_set_iana_protocol_name(idmef_service_t *ptr, requiem_string_t *iana_protocol_name)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_service_new_iana_protocol_name(idmef_service_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->iana_protocol_name ) {
                retval = requiem_string_new(&ptr->iana_protocol_name);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_service_get_name(idmef_service_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_service_set_name(idmef_service_t *ptr, requiem_string_t *name)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_service_new_name(idmef_service_t *ptr, requiem_string_t **ret)
{
        int retval;
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_service_get_portlist(idmef_service_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_service_t object.
 * @portlist: pointer to a #requiem_string_t object.
 *
...
void idmef_service_set_portlist(idmef_service_t *ptr, requiem_string_t *portlist)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_service_new_portlist(idmef_service_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->portlist ) {
                retval = requiem_string_new(&ptr->portlist);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_service_get_protocol(idmef_service_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_service_t object.
 * @protocol: pointer to a #requiem_string_t object.
 *
...
void idmef_service_set_protocol(idmef_service_t *ptr, requiem_string_t *protocol)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_service_new_protocol(idmef_service_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->protocol ) {
                retval = requiem_string_new(&ptr->protocol);
                if ( retval < 0 )
                        return retval;
        }
...
{
        requiem_return_val_if_fail(ptr, NULL);
...
int idmef_service_copy(const idmef_service_t *src, idmef_service_t *dst)
{
        ...
        if ( src->iana_protocol_name ) {
                ret = requiem_string_clone(src->iana_protocol_name, &dst->iana_protocol_name);
                if ( ret < 0 )
                        return ret;
        }
        ...
        if ( src->portlist ) {
                ret = requiem_string_clone(src->portlist, &dst->portlist);
                if ( ret < 0 )
                        return ret;
        }

        if ( src->protocol ) {
                ret = requiem_string_clone(src->protocol, &dst->protocol);
                if ( ret < 0 )
                        return ret;
        }
...
int idmef_service_compare(const idmef_service_t *obj1, const idmef_service_t *obj2)
{
        ...
        ret = requiem_string_compare(obj1->iana_protocol_name, obj2->iana_protocol_name);
        if ( ret != 0 )
                return ret;
        ...
        ret = requiem_string_compare(obj1->portlist, obj2->portlist);
        if ( ret != 0 )
                return ret;

        ret = requiem_string_compare(obj1->protocol, obj2->protocol);
        if ( ret != 0 )
                return ret;
...
int idmef_node_new(idmef_node_t **ret)
{
        *ret = calloc(1, sizeof(**ret));
        ...
        requiem_list_init(&(*ret)->address_list);
...
{
        requiem_return_val_if_fail(node, NULL);
        node->refcount++;
...
int _idmef_node_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        return idmef_node_new_ident(ptr, (requiem_string_t **) ret);

                case 1:
                        return idmef_node_new_category(ptr, (idmef_node_category_t **) ret);

                case 2:
                        return idmef_node_new_location(ptr, (requiem_string_t **) ret);

                case 3:
                        return idmef_node_new_name(ptr, (requiem_string_t **) ret);
                ...
                case 4: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->address_list, tmp) {
                                       if ( i++ == n ) {
                                               *ret = requiem_list_entry(tmp, idmef_address_t, list);
                                               return 0;
                                       }
                               }
                               ...
                               requiem_list_for_each_reversed(&ptr->address_list, tmp) {
                                       if ( i++ == pos ) {
                                               *ret = requiem_list_entry(tmp, idmef_address_t, list);
                                               return 0;
                                       }
...
int _idmef_node_destroy_child(void *p, idmef_class_child_id_t child, int n)
{
        ...
        switch ( child ) {
                ...
                case 2:
                        if ( ptr->location ) {
                                requiem_string_destroy(ptr->location);
                                ptr->location = NULL;
                        }
                ...
                case 4: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->address_list, tmp) {
                                       if ( i++ == n ) {
                                               void *b = requiem_list_entry(tmp, idmef_address_t, list);
...
static void idmef_node_destroy_internal(idmef_node_t *ptr)
{
...

        {
                ...
                requiem_list_for_each_safe(&ptr->address_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_address_t, list);
                        requiem_list_del_init(&entry->list);
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_node_get_ident(idmef_node_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_node_set_ident(idmef_node_t *ptr, requiem_string_t *ident)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_node_new_ident(idmef_node_t *ptr, requiem_string_t **ret)
{
        int retval;
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_node_get_location(idmef_node_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_node_t object.
 * @location: pointer to a #requiem_string_t object.
 *
...
void idmef_node_set_location(idmef_node_t *ptr, requiem_string_t *location)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_node_new_location(idmef_node_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->location ) {
                retval = requiem_string_new(&ptr->location);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_node_get_name(idmef_node_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_node_set_name(idmef_node_t *ptr, requiem_string_t *name)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_node_new_name(idmef_node_t *ptr, requiem_string_t **ret)
{
        int retval;
...
{
        requiem_list_t *tmp = (address_cur) ? &address_cur->list : NULL;

        requiem_return_val_if_fail(node, NULL);

        requiem_list_for_each_continue(&node->address_list, tmp)
                return requiem_list_entry(tmp, idmef_address_t, list);
...
int idmef_node_copy(const idmef_node_t *src, idmef_node_t *dst)
{
        ...
        if ( src->location ) {
                ret = requiem_string_clone(src->location, &dst->location);
                if ( ret < 0 )
                        return ret;
        }
...

        {
                ...
                requiem_list_for_each_safe(&src->address_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_address_t, list);
                        idmef_address_clone(entry, &new);
                        requiem_list_add_tail(&dst->address_list, &new->list);
                }
        }
...
int idmef_node_compare(const idmef_node_t *obj1, const idmef_node_t *obj2)
{
        ...
        ret = requiem_string_compare(obj1->location, obj2->location);
        if ( ret != 0 )
                return ret;
...

        {
                ...
                do {
                        ...
                        requiem_list_for_each_continue(&obj1->address_list, tmp1) {
                                entry1 = requiem_list_entry(tmp1, idmef_address_t, list);
                                break;
                        }

                        requiem_list_for_each_continue(&obj2->address_list, tmp2) {
                                entry2 = requiem_list_entry(tmp2, idmef_address_t, list);
                                break;
                        }
...
{
        requiem_return_val_if_fail(source, NULL);
        source->refcount++;
...
int _idmef_source_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        return idmef_source_new_ident(ptr, (requiem_string_t **) ret);

                case 1:
                        return idmef_source_new_spoofed(ptr, (idmef_source_spoofed_t **) ret);

                case 2:
                        return idmef_source_new_interface(ptr, (requiem_string_t **) ret);
...
int _idmef_source_destroy_child(void *p, idmef_class_child_id_t child, int n)
{
        ...
        switch ( child ) {
                ...
                case 2:
                        if ( ptr->interface ) {
                                requiem_string_destroy(ptr->interface);
                                ptr->interface = NULL;
                        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_source_get_ident(idmef_source_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_source_set_ident(idmef_source_t *ptr, requiem_string_t *ident)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_source_new_ident(idmef_source_t *ptr, requiem_string_t **ret)
{
        int retval;
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_source_get_interface(idmef_source_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_source_t object.
 * @interface: pointer to a #requiem_string_t object.
 *
...
void idmef_source_set_interface(idmef_source_t *ptr, requiem_string_t *interface)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_source_new_interface(idmef_source_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->interface ) {
                retval = requiem_string_new(&ptr->interface);
                if ( retval < 0 )
                        return retval;
        }
...
int idmef_source_copy(const idmef_source_t *src, idmef_source_t *dst)
{
        ...
        if ( src->interface ) {
                ret = requiem_string_clone(src->interface, &dst->interface);
                if ( ret < 0 )
                        return ret;
        }
...
int idmef_source_compare(const idmef_source_t *obj1, const idmef_source_t *obj2)
{
        ...
        ret = requiem_string_compare(obj1->interface, obj2->interface);
        if ( ret != 0 )
                return ret;
...
int idmef_file_access_new(idmef_file_access_t **ret)
{
        *ret = calloc(1, sizeof(**ret));
        ...
        requiem_list_init(&(*ret)->permission_list);
...
{
        requiem_return_val_if_fail(file_access, NULL);
...
int _idmef_file_access_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 1: {
                        ...
                        if ( n == IDMEF_LIST_APPEND || n == IDMEF_LIST_PREPEND )
                               return idmef_file_access_new_permission(ptr, (requiem_string_t **) ret, n);

                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->permission_list, tmp) {
                                       if ( i++ == n ) {
                                               *ret = requiem_list_entry(tmp, requiem_string_t, list);
                                               return 0;
                                       }
                               ...
                               requiem_list_for_each_reversed(&ptr->permission_list, tmp) {
                                       if ( i++ == pos ) {
                                               *ret = requiem_list_entry(tmp, requiem_string_t, list);
                                               return 0;
                                       }
...
static void idmef_file_access_destroy_internal(idmef_file_access_t *ptr)
{
       ...
       if ( ! requiem_list_is_empty(&ptr->list) )
...

        {
                ...
                requiem_list_for_each_safe(&ptr->permission_list, tmp, n) {
                        entry = requiem_list_entry(tmp, requiem_string_t, list);
                        requiem_list_del_init(&entry->list);
                        requiem_string_destroy(entry);
                }
 ...
 * Returns: the next #requiem_string_t in the list.
 */
requiem_string_t *idmef_file_access_get_next_permission(idmef_file_access_t *file_access, requiem_string_t *requiem_string_cur)
{
        requiem_list_t *tmp = (requiem_string_cur) ? &requiem_string_cur->list : NULL;

        requiem_return_val_if_fail(file_access, NULL);

        requiem_list_for_each_continue(&file_access->permission_list, tmp)
                return requiem_list_entry(tmp, requiem_string_t, list);
 ...
 * If @pos is #IDMEF_LIST_PREPEND, @object will be inserted at the head of the list.
 */
void idmef_file_access_set_permission(idmef_file_access_t *ptr, requiem_string_t *object, int pos)
{
        requiem_return_if_fail(ptr);
        requiem_return_if_fail(object);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_file_access_new_permission(idmef_file_access_t *ptr, requiem_string_t **ret, int pos)
{
        int retval;
...
int idmef_file_access_copy(const idmef_file_access_t *src, idmef_file_access_t *dst)
{
...

        {
                ...
                requiem_list_for_each_safe(&src->permission_list, tmp, n) {
                        entry = requiem_list_entry(tmp, requiem_string_t, list);
                        requiem_string_clone(entry, &new);
                        requiem_list_add_tail(&dst->permission_list, &new->list);
                }
        }
...
int idmef_file_access_compare(const idmef_file_access_t *obj1, const idmef_file_access_t *obj2)
{
...

        {
                ...
                do {
                        ...
                        requiem_list_for_each_continue(&obj1->permission_list, tmp1) {
                                entry1 = requiem_list_entry(tmp1, requiem_string_t, list);
                                break;
                        }

                        requiem_list_for_each_continue(&obj2->permission_list, tmp2) {
                                entry2 = requiem_list_entry(tmp2, requiem_string_t, list);
                                break;
                        }
...
{
        requiem_return_val_if_fail(inode, NULL);
        inode->refcount++;
...
int idmef_checksum_new(idmef_checksum_t **ret)
{
        *ret = calloc(1, sizeof(**ret));
        ...
        {
                int retval = requiem_string_new(&(*ret)->value);
...
{
        requiem_return_val_if_fail(checksum, NULL);
        checksum->refcount++;
...
int _idmef_checksum_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        return idmef_checksum_new_value(ptr, (requiem_string_t **) ret);

                case 1:
                        return idmef_checksum_new_key(ptr, (requiem_string_t **) ret);
...
int _idmef_checksum_destroy_child(void *p, idmef_class_child_id_t child, int n)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        if ( ptr->value ) {
                                requiem_string_destroy(ptr->value);
                                ptr->value = NULL;
                        }
                ...
                case 1:
                        if ( ptr->key ) {
                                requiem_string_destroy(ptr->key);
                                ptr->key = NULL;
                        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_checksum_get_value(idmef_checksum_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_checksum_t object.
 * @value: pointer to a #requiem_string_t object.
 *
...
void idmef_checksum_set_value(idmef_checksum_t *ptr, requiem_string_t *value)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_checksum_new_value(idmef_checksum_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->value ) {
                retval = requiem_string_new(&ptr->value);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_checksum_get_key(idmef_checksum_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_checksum_t object.
 * @key: pointer to a #requiem_string_t object.
 *
...
void idmef_checksum_set_key(idmef_checksum_t *ptr, requiem_string_t *key)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_checksum_new_key(idmef_checksum_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->key ) {
                retval = requiem_string_new(&ptr->key);
                if ( retval < 0 )
                        return retval;
        }
...
int idmef_checksum_copy(const idmef_checksum_t *src, idmef_checksum_t *dst)
{
        ...
        if ( src->value ) {
                ret = requiem_string_copy(src->value, dst->value);
                if ( ret < 0 )
                        return ret;
        }

        if ( src->key ) {
                ret = requiem_string_clone(src->key, &dst->key);
                if ( ret < 0 )
                        return ret;
        }
...
int idmef_checksum_compare(const idmef_checksum_t *obj1, const idmef_checksum_t *obj2)
{
        ...
        ret = requiem_string_compare(obj1->value, obj2->value);
        if ( ret != 0 )
                return ret;

        ret = requiem_string_compare(obj1->key, obj2->key);
        if ( ret != 0 )
                return ret;
...
int idmef_file_new(idmef_file_t **ret)
{
        *ret = calloc(1, sizeof(**ret));
        ...
        requiem_list_init(&(*ret)->file_access_list);


        requiem_list_init(&(*ret)->linkage_list);


        requiem_list_init(&(*ret)->checksum_list);
        ...
        {
                int retval = requiem_string_new(&(*ret)->path);
...
{
        requiem_return_val_if_fail(file, NULL);
        file->refcount++;
...
int _idmef_file_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        return idmef_file_new_ident(ptr, (requiem_string_t **) ret);

                case 1:
                        return idmef_file_new_name(ptr, (requiem_string_t **) ret);

                case 2:
                        return idmef_file_new_path(ptr, (requiem_string_t **) ret);
                ...
                case 8: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->file_access_list, tmp) {
                                       if ( i++ == n ) {
                                               *ret = requiem_list_entry(tmp, idmef_file_access_t, list);
                                               return 0;
                                       }
                               }
                               ...
                               requiem_list_for_each_reversed(&ptr->file_access_list, tmp) {
                                       if ( i++ == pos ) {
                                               *ret = requiem_list_entry(tmp, idmef_file_access_t, list);
                                               return 0;
                                       }
                ...
                case 9: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->linkage_list, tmp) {
                                       if ( i++ == n ) {
                                               *ret = requiem_list_entry(tmp, idmef_linkage_t, list);
                                               return 0;
                                       }
                               }
                               ...
                               requiem_list_for_each_reversed(&ptr->linkage_list, tmp) {
                                       if ( i++ == pos ) {
                                               *ret = requiem_list_entry(tmp, idmef_linkage_t, list);
                                               return 0;
                                       }
                ...
                case 11: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->checksum_list, tmp) {
                                       if ( i++ == n ) {
                                               *ret = requiem_list_entry(tmp, idmef_checksum_t, list);
                                               return 0;
                                       }
                               }
                               ...
                               requiem_list_for_each_reversed(&ptr->checksum_list, tmp) {
                                       if ( i++ == pos ) {
                                               *ret = requiem_list_entry(tmp, idmef_checksum_t, list);
                                               return 0;
                                       }
                ...
                case 14:
                        return idmef_file_new_file_type(ptr, (requiem_string_t **) ret);
        ...
        switch ( child ) {
                ...
                case 8: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->file_access_list, tmp) {
                                       if ( i++ == n ) {
                                               void *b = requiem_list_entry(tmp, idmef_file_access_t, list);
                ...
                case 9: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->linkage_list, tmp) {
                                       if ( i++ == n ) {
                                               void *b = requiem_list_entry(tmp, idmef_linkage_t, list);
                ...
                case 11: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->checksum_list, tmp) {
                                       if ( i++ == n ) {
                                               void *b = requiem_list_entry(tmp, idmef_checksum_t, list);
                ...
                case 14:
                        if ( ptr->file_type ) {
                                requiem_string_destroy(ptr->file_type);
                                ptr->file_type = NULL;
                        }
...
static void idmef_file_destroy_internal(idmef_file_t *ptr)
{
       ...
       if ( ! requiem_list_is_empty(&ptr->list) )
...

        {
                ...
                requiem_list_for_each_safe(&ptr->file_access_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_file_access_t, list);
                        requiem_list_del_init(&entry->list);
...

        {
                ...
                requiem_list_for_each_safe(&ptr->linkage_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_linkage_t, list);
                        requiem_list_del_init(&entry->list);
...

        {
                ...
                requiem_list_for_each_safe(&ptr->checksum_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_checksum_t, list);
                        requiem_list_del_init(&entry->list);
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_file_get_ident(idmef_file_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_file_set_ident(idmef_file_t *ptr, requiem_string_t *ident)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_file_new_ident(idmef_file_t *ptr, requiem_string_t **ret)
{
        int retval;
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_file_get_name(idmef_file_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_file_set_name(idmef_file_t *ptr, requiem_string_t *name)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_file_new_name(idmef_file_t *ptr, requiem_string_t **ret)
{
        int retval;
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_file_get_path(idmef_file_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_file_set_path(idmef_file_t *ptr, requiem_string_t *path)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_file_new_path(idmef_file_t *ptr, requiem_string_t **ret)
{
        int retval;
...
{
        requiem_list_t *tmp = (file_access_cur) ? &file_access_cur->list : NULL;

        requiem_return_val_if_fail(file, NULL);

        requiem_list_for_each_continue(&file->file_access_list, tmp)
                return requiem_list_entry(tmp, idmef_file_access_t, list);
...
{
        requiem_list_t *tmp = (linkage_cur) ? &linkage_cur->list : NULL;

        requiem_return_val_if_fail(file, NULL);

        requiem_list_for_each_continue(&file->linkage_list, tmp)
                return requiem_list_entry(tmp, idmef_linkage_t, list);
...
{
        requiem_list_t *tmp = (checksum_cur) ? &checksum_cur->list : NULL;

        requiem_return_val_if_fail(file, NULL);

        requiem_list_for_each_continue(&file->checksum_list, tmp)
                return requiem_list_entry(tmp, idmef_checksum_t, list);
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_file_get_file_type(idmef_file_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_file_t object.
 * @file_type: pointer to a #requiem_string_t object.
 *
...
void idmef_file_set_file_type(idmef_file_t *ptr, requiem_string_t *file_type)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_file_new_file_type(idmef_file_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->file_type ) {
                retval = requiem_string_new(&ptr->file_type);
                if ( retval < 0 )
                        return retval;
        }
...
int idmef_file_copy(const idmef_file_t *src, idmef_file_t *dst)
{
        ...
        if ( src->path ) {
                ret = requiem_string_copy(src->path, dst->path);
                if ( ret < 0 )
                        return ret;
        }
...

        {
                ...
                requiem_list_for_each_safe(&src->file_access_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_file_access_t, list);
                        idmef_file_access_clone(entry, &new);
                        requiem_list_add_tail(&dst->file_access_list, &new->list);
                }
        }

        {
                ...
                requiem_list_for_each_safe(&src->linkage_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_linkage_t, list);
                        idmef_linkage_clone(entry, &new);
                        requiem_list_add_tail(&dst->linkage_list, &new->list);
                }
        }
...

        {
                ...
                requiem_list_for_each_safe(&src->checksum_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_checksum_t, list);
                        idmef_checksum_clone(entry, &new);
                        requiem_list_add_tail(&dst->checksum_list, &new->list);
                }
        }
        ...
        if ( src->file_type ) {
                ret = requiem_string_clone(src->file_type, &dst->file_type);
                if ( ret < 0 )
                        return ret;
        }
...
int idmef_file_compare(const idmef_file_t *obj1, const idmef_file_t *obj2)
{
...

        {
                ...
                do {
                        ...
                        requiem_list_for_each_continue(&obj1->file_access_list, tmp1) {
                                entry1 = requiem_list_entry(tmp1, idmef_file_access_t, list);
                                break;
                        }

                        requiem_list_for_each_continue(&obj2->file_access_list, tmp2) {
                                entry2 = requiem_list_entry(tmp2, idmef_file_access_t, list);
                                break;
                        }
...

        {
                ...
                do {
                        ...
                        requiem_list_for_each_continue(&obj1->linkage_list, tmp1) {
                                entry1 = requiem_list_entry(tmp1, idmef_linkage_t, list);
                                break;
                        }

                        requiem_list_for_each_continue(&obj2->linkage_list, tmp2) {
                                entry2 = requiem_list_entry(tmp2, idmef_linkage_t, list);
                                break;
                        }
...

        {
                ...
                do {
                        ...
                        requiem_list_for_each_continue(&obj1->checksum_list, tmp1) {
                                entry1 = requiem_list_entry(tmp1, idmef_checksum_t, list);
                                break;
                        }

                        requiem_list_for_each_continue(&obj2->checksum_list, tmp2) {
                                entry2 = requiem_list_entry(tmp2, idmef_checksum_t, list);
                                break;
                        }
        ...
        ret = requiem_string_compare(obj1->file_type, obj2->file_type);
        if ( ret != 0 )
                return ret;
...
{
        requiem_return_val_if_fail(linkage, NULL);
        linkage->refcount++;
...
int _idmef_linkage_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 1:
                        return idmef_linkage_new_name(ptr, (requiem_string_t **) ret);

                case 2:
                        return idmef_linkage_new_path(ptr, (requiem_string_t **) ret);
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_linkage_get_name(idmef_linkage_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_linkage_set_name(idmef_linkage_t *ptr, requiem_string_t *name)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_linkage_new_name(idmef_linkage_t *ptr, requiem_string_t **ret)
{
        int retval;
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_linkage_get_path(idmef_linkage_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_linkage_set_path(idmef_linkage_t *ptr, requiem_string_t *path)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_linkage_new_path(idmef_linkage_t *ptr, requiem_string_t **ret)
{
        int retval;
...
int idmef_target_new(idmef_target_t **ret)
{
        *ret = calloc(1, sizeof(**ret));
        ...
        requiem_list_init(&(*ret)->file_list);
...
{
        requiem_return_val_if_fail(target, NULL);
        target->refcount++;
...
int _idmef_target_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        return idmef_target_new_ident(ptr, (requiem_string_t **) ret);

                case 1:
                        return idmef_target_new_decoy(ptr, (idmef_target_decoy_t **) ret);

                case 2:
                        return idmef_target_new_interface(ptr, (requiem_string_t **) ret);
                ...
                case 7: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->file_list, tmp) {
                                       if ( i++ == n ) {
                                               *ret = requiem_list_entry(tmp, idmef_file_t, list);
                                               return 0;
                                       }
                               }
                               ...
                               requiem_list_for_each_reversed(&ptr->file_list, tmp) {
                                       if ( i++ == pos ) {
                                               *ret = requiem_list_entry(tmp, idmef_file_t, list);
                                               return 0;
                                       }
        ...
        switch ( child ) {
                ...
                case 7: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->file_list, tmp) {
                                       if ( i++ == n ) {
                                               void *b = requiem_list_entry(tmp, idmef_file_t, list);
...
static void idmef_target_destroy_internal(idmef_target_t *ptr)
{
       ...
       if ( ! requiem_list_is_empty(&ptr->list) )
...

        {
                ...
                requiem_list_for_each_safe(&ptr->file_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_file_t, list);
                        requiem_list_del_init(&entry->list);
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_target_get_ident(idmef_target_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_target_set_ident(idmef_target_t *ptr, requiem_string_t *ident)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_target_new_ident(idmef_target_t *ptr, requiem_string_t **ret)
{
        int retval;
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_target_get_interface(idmef_target_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_target_set_interface(idmef_target_t *ptr, requiem_string_t *interface)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_target_new_interface(idmef_target_t *ptr, requiem_string_t **ret)
{
        int retval;
...
{
        requiem_list_t *tmp = (file_cur) ? &file_cur->list : NULL;

        requiem_return_val_if_fail(target, NULL);

        requiem_list_for_each_continue(&target->file_list, tmp)
                return requiem_list_entry(tmp, idmef_file_t, list);
...
int idmef_target_copy(const idmef_target_t *src, idmef_target_t *dst)
{
...

        {
                ...
                requiem_list_for_each_safe(&src->file_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_file_t, list);
                        idmef_file_clone(entry, &new);
                        requiem_list_add_tail(&dst->file_list, &new->list);
                }
        }
...
int idmef_target_compare(const idmef_target_t *obj1, const idmef_target_t *obj2)
{
...

        {
                ...
                do {
                        ...
                        requiem_list_for_each_continue(&obj1->file_list, tmp1) {
                                entry1 = requiem_list_entry(tmp1, idmef_file_t, list);
                                break;
                        }

                        requiem_list_for_each_continue(&obj2->file_list, tmp2) {
                                entry2 = requiem_list_entry(tmp2, idmef_file_t, list);
                                break;
                        }
...
{
        requiem_return_val_if_fail(analyzer, NULL);
        analyzer->refcount++;
...
int _idmef_analyzer_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        return idmef_analyzer_new_analyzerid(ptr, (requiem_string_t **) ret);

                case 1:
                        return idmef_analyzer_new_name(ptr, (requiem_string_t **) ret);

                case 2:
                        return idmef_analyzer_new_manufacturer(ptr, (requiem_string_t **) ret);

                case 3:
                        return idmef_analyzer_new_model(ptr, (requiem_string_t **) ret);

                case 4:
                        return idmef_analyzer_new_version(ptr, (requiem_string_t **) ret);

                case 5:
                        return idmef_analyzer_new_class(ptr, (requiem_string_t **) ret);

                case 6:
                        return idmef_analyzer_new_ostype(ptr, (requiem_string_t **) ret);

                case 7:
                        return idmef_analyzer_new_osversion(ptr, (requiem_string_t **) ret);
...
int _idmef_analyzer_destroy_child(void *p, idmef_class_child_id_t child, int n)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        if ( ptr->analyzerid ) {
                                requiem_string_destroy(ptr->analyzerid);
                                ptr->analyzerid = NULL;
                        }
                ...
                case 2:
                        if ( ptr->manufacturer ) {
                                requiem_string_destroy(ptr->manufacturer);
                ...
                case 3:
                        if ( ptr->model ) {
                                requiem_string_destroy(ptr->model);
                                ptr->model = NULL;
                        }
                ...
                case 4:
                        if ( ptr->version ) {
                                requiem_string_destroy(ptr->version);
                                ptr->version = NULL;
                        }
                ...
                case 5:
                        if ( ptr->class ) {
                                requiem_string_destroy(ptr->class);
                                ptr->class = NULL;
                        }
                ...
                case 6:
                        if ( ptr->ostype ) {
                                requiem_string_destroy(ptr->ostype);
                                ptr->ostype = NULL;
                        }
                ...
                case 7:
                        if ( ptr->osversion ) {
                                requiem_string_destroy(ptr->osversion);
                                ptr->osversion = NULL;
                        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_analyzer_get_analyzerid(idmef_analyzer_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_analyzer_t object.
 * @analyzerid: pointer to a #requiem_string_t object.
 *
...
void idmef_analyzer_set_analyzerid(idmef_analyzer_t *ptr, requiem_string_t *analyzerid)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_analyzer_new_analyzerid(idmef_analyzer_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->analyzerid ) {
                retval = requiem_string_new(&ptr->analyzerid);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_analyzer_get_name(idmef_analyzer_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_analyzer_set_name(idmef_analyzer_t *ptr, requiem_string_t *name)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_analyzer_new_name(idmef_analyzer_t *ptr, requiem_string_t **ret)
{
        int retval;
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_analyzer_get_manufacturer(idmef_analyzer_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_analyzer_t object.
 * @manufacturer: pointer to a #requiem_string_t object.
 *
...
void idmef_analyzer_set_manufacturer(idmef_analyzer_t *ptr, requiem_string_t *manufacturer)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_analyzer_new_manufacturer(idmef_analyzer_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->manufacturer ) {
                retval = requiem_string_new(&ptr->manufacturer);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_analyzer_get_model(idmef_analyzer_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_analyzer_t object.
 * @model: pointer to a #requiem_string_t object.
 *
...
void idmef_analyzer_set_model(idmef_analyzer_t *ptr, requiem_string_t *model)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_analyzer_new_model(idmef_analyzer_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->model ) {
                retval = requiem_string_new(&ptr->model);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_analyzer_get_version(idmef_analyzer_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_analyzer_t object.
 * @version: pointer to a #requiem_string_t object.
 *
...
void idmef_analyzer_set_version(idmef_analyzer_t *ptr, requiem_string_t *version)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_analyzer_new_version(idmef_analyzer_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->version ) {
                retval = requiem_string_new(&ptr->version);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_analyzer_get_class(idmef_analyzer_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_analyzer_t object.
 * @class_str: pointer to a #requiem_string_t object.
 *
...
void idmef_analyzer_set_class(idmef_analyzer_t *ptr, requiem_string_t *class_str)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_analyzer_new_class(idmef_analyzer_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->class ) {
                retval = requiem_string_new(&ptr->class);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_analyzer_get_ostype(idmef_analyzer_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_analyzer_t object.
 * @ostype: pointer to a #requiem_string_t object.
 *
...
void idmef_analyzer_set_ostype(idmef_analyzer_t *ptr, requiem_string_t *ostype)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_analyzer_new_ostype(idmef_analyzer_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->ostype ) {
                retval = requiem_string_new(&ptr->ostype);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_analyzer_get_osversion(idmef_analyzer_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_analyzer_t object.
 * @osversion: pointer to a #requiem_string_t object.
 *
...
void idmef_analyzer_set_osversion(idmef_analyzer_t *ptr, requiem_string_t *osversion)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_analyzer_new_osversion(idmef_analyzer_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->osversion ) {
                retval = requiem_string_new(&ptr->osversion);
                if ( retval < 0 )
                        return retval;
        }
...
int idmef_analyzer_copy(const idmef_analyzer_t *src, idmef_analyzer_t *dst)
{
        ...
        if ( src->analyzerid ) {
                ret = requiem_string_clone(src->analyzerid, &dst->analyzerid);
                if ( ret < 0 )
                        return ret;
        }
        ...
        if ( src->manufacturer ) {
                ret = requiem_string_clone(src->manufacturer, &dst->manufacturer);
                if ( ret < 0 )
                        return ret;
        }

        if ( src->model ) {
                ret = requiem_string_clone(src->model, &dst->model);
                if ( ret < 0 )
                        return ret;
        }

        if ( src->version ) {
                ret = requiem_string_clone(src->version, &dst->version);
                if ( ret < 0 )
                        return ret;
        }

        if ( src->class ) {
                ret = requiem_string_clone(src->class, &dst->class);
                if ( ret < 0 )
                        return ret;
        }

        if ( src->ostype ) {
                ret = requiem_string_clone(src->ostype, &dst->ostype);
                if ( ret < 0 )
                        return ret;
        }

        if ( src->osversion ) {
                ret = requiem_string_clone(src->osversion, &dst->osversion);
                if ( ret < 0 )
                        return ret;
        }
...
int idmef_analyzer_compare(const idmef_analyzer_t *obj1, const idmef_analyzer_t *obj2)
{
        ...
        ret = requiem_string_compare(obj1->analyzerid, obj2->analyzerid);
        if ( ret != 0 )
                return ret;
        ...
        ret = requiem_string_compare(obj1->manufacturer, obj2->manufacturer);
        if ( ret != 0 )
                return ret;

        ret = requiem_string_compare(obj1->model, obj2->model);
        if ( ret != 0 )
                return ret;

        ret = requiem_string_compare(obj1->version, obj2->version);
        if ( ret != 0 )
                return ret;

        ret = requiem_string_compare(obj1->class, obj2->class);
        if ( ret != 0 )
                return ret;

        ret = requiem_string_compare(obj1->ostype, obj2->ostype);
        if ( ret != 0 )
                return ret;

        ret = requiem_string_compare(obj1->osversion, obj2->osversion);
        if ( ret != 0 )
                return ret;
...
int idmef_alertident_new(idmef_alertident_t **ret)
{
        *ret = calloc(1, sizeof(**ret));
        ...
        {
                int retval = requiem_string_new(&(*ret)->alertident);
...
{
        requiem_return_val_if_fail(alertident, NULL);
        alertident->refcount++;
...
int _idmef_alertident_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        return idmef_alertident_new_alertident(ptr, (requiem_string_t **) ret);

                case 1:
                        return idmef_alertident_new_analyzerid(ptr, (requiem_string_t **) ret);
...
int _idmef_alertident_destroy_child(void *p, idmef_class_child_id_t child, int n)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        if ( ptr->alertident ) {
                                requiem_string_destroy(ptr->alertident);
                                ptr->alertident = NULL;
                        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_alertident_get_alertident(idmef_alertident_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_alertident_t object.
 * @alertident: pointer to a #requiem_string_t object.
 *
...
void idmef_alertident_set_alertident(idmef_alertident_t *ptr, requiem_string_t *alertident)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_alertident_new_alertident(idmef_alertident_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->alertident ) {
                retval = requiem_string_new(&ptr->alertident);
                if ( retval < 0 )
                        return retval;
        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_alertident_get_analyzerid(idmef_alertident_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_alertident_set_analyzerid(idmef_alertident_t *ptr, requiem_string_t *analyzerid)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_alertident_new_analyzerid(idmef_alertident_t *ptr, requiem_string_t **ret)
{
        int retval;
...
int idmef_alertident_copy(const idmef_alertident_t *src, idmef_alertident_t *dst)
{
        ...
        if ( src->alertident ) {
                ret = requiem_string_copy(src->alertident, dst->alertident);
                if ( ret < 0 )
                        return ret;
        }
...
int idmef_alertident_compare(const idmef_alertident_t *obj1, const idmef_alertident_t *obj2)
{
        ...
        ret = requiem_string_compare(obj1->alertident, obj2->alertident);
        if ( ret != 0 )
                return ret;
...
{
        requiem_return_val_if_fail(impact, NULL);
        impact->refcount++;
...
int _idmef_impact_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 3:
                        return idmef_impact_new_description(ptr, (requiem_string_t **) ret);
...
int _idmef_impact_destroy_child(void *p, idmef_class_child_id_t child, int n)
{
        ...
        switch ( child ) {
                ...
                case 3:
                        if ( ptr->description ) {
                                requiem_string_destroy(ptr->description);
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_impact_get_description(idmef_impact_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_impact_t object.
 * @description: pointer to a #requiem_string_t object.
 *
...
void idmef_impact_set_description(idmef_impact_t *ptr, requiem_string_t *description)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_impact_new_description(idmef_impact_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->description ) {
                retval = requiem_string_new(&ptr->description);
                if ( retval < 0 )
                        return retval;
        }
...
int idmef_impact_copy(const idmef_impact_t *src, idmef_impact_t *dst)
{
        ...
        if ( src->description ) {
                ret = requiem_string_clone(src->description, &dst->description);
                if ( ret < 0 )
                        return ret;
        }
...
int idmef_impact_compare(const idmef_impact_t *obj1, const idmef_impact_t *obj2)
{
        ...
        ret = requiem_string_compare(obj1->description, obj2->description);
        if ( ret != 0 )
                return ret;
...
{
        requiem_return_val_if_fail(action, NULL);
        action->refcount++;
...
int _idmef_action_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 1:
                        return idmef_action_new_description(ptr, (requiem_string_t **) ret);
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_action_get_description(idmef_action_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_action_set_description(idmef_action_t *ptr, requiem_string_t *description)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_action_new_description(idmef_action_t *ptr, requiem_string_t **ret)
{
        int retval;
...
{
        requiem_return_val_if_fail(confidence, NULL);
        confidence->refcount++;
...
int idmef_assessment_new(idmef_assessment_t **ret)
{
        *ret = calloc(1, sizeof(**ret));
        ...
        requiem_list_init(&(*ret)->action_list);
...
{
        requiem_return_val_if_fail(assessment, NULL);
        assessment->refcount++;
...
int _idmef_assessment_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 1: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->action_list, tmp) {
                                       if ( i++ == n ) {
                                               *ret = requiem_list_entry(tmp, idmef_action_t, list);
                                               return 0;
                                       }
                               }
                               ...
                               requiem_list_for_each_reversed(&ptr->action_list, tmp) {
                                       if ( i++ == pos ) {
                                               *ret = requiem_list_entry(tmp, idmef_action_t, list);
                                               return 0;
                                       }
        ...
        switch ( child ) {
                ...
                case 1: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->action_list, tmp) {
                                       if ( i++ == n ) {
                                               void *b = requiem_list_entry(tmp, idmef_action_t, list);
...
static void idmef_assessment_destroy_internal(idmef_assessment_t *ptr)
{
...

        {
                ...
                requiem_list_for_each_safe(&ptr->action_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_action_t, list);
                        requiem_list_del_init(&entry->list);
...
{
        requiem_list_t *tmp = (action_cur) ? &action_cur->list : NULL;

        requiem_return_val_if_fail(assessment, NULL);

        requiem_list_for_each_continue(&assessment->action_list, tmp)
                return requiem_list_entry(tmp, idmef_action_t, list);
...
int idmef_assessment_copy(const idmef_assessment_t *src, idmef_assessment_t *dst)
{
...

        {
                ...
                requiem_list_for_each_safe(&src->action_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_action_t, list);
                        idmef_action_clone(entry, &new);
                        requiem_list_add_tail(&dst->action_list, &new->list);
                }
        }
...
int idmef_assessment_compare(const idmef_assessment_t *obj1, const idmef_assessment_t *obj2)
{
...

        {
                ...
                do {
                        ...
                        requiem_list_for_each_continue(&obj1->action_list, tmp1) {
                                entry1 = requiem_list_entry(tmp1, idmef_action_t, list);
                                break;
                        }

                        requiem_list_for_each_continue(&obj2->action_list, tmp2) {
                                entry2 = requiem_list_entry(tmp2, idmef_action_t, list);
                                break;
                        }
...
int idmef_tool_alert_new(idmef_tool_alert_t **ret)
{
        *ret = calloc(1, sizeof(**ret));
        ...
        requiem_list_init(&(*ret)->alertident_list);
...
{
        requiem_return_val_if_fail(tool_alert, NULL);
        tool_alert->refcount++;
...
int _idmef_tool_alert_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        return idmef_tool_alert_new_name(ptr, (requiem_string_t **) ret);

                case 1:
                        return idmef_tool_alert_new_command(ptr, (requiem_string_t **) ret);
                ...
                case 2: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->alertident_list, tmp) {
                                       if ( i++ == n ) {
                                               *ret = requiem_list_entry(tmp, idmef_alertident_t, list);
                                               return 0;
                                       }
                               }
                               ...
                               requiem_list_for_each_reversed(&ptr->alertident_list, tmp) {
                                       if ( i++ == pos ) {
                                               *ret = requiem_list_entry(tmp, idmef_alertident_t, list);
                                               return 0;
                                       }
        ...
        switch ( child ) {
                ...
                case 2: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->alertident_list, tmp) {
                                       if ( i++ == n ) {
                                               void *b = requiem_list_entry(tmp, idmef_alertident_t, list);
...
static void idmef_tool_alert_destroy_internal(idmef_tool_alert_t *ptr)
{
...

        {
                ...
                requiem_list_for_each_safe(&ptr->alertident_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_alertident_t, list);
                        requiem_list_del_init(&entry->list);
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_tool_alert_get_name(idmef_tool_alert_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_tool_alert_set_name(idmef_tool_alert_t *ptr, requiem_string_t *name)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_tool_alert_new_name(idmef_tool_alert_t *ptr, requiem_string_t **ret)
{
        int retval;
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_tool_alert_get_command(idmef_tool_alert_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_tool_alert_set_command(idmef_tool_alert_t *ptr, requiem_string_t *command)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_tool_alert_new_command(idmef_tool_alert_t *ptr, requiem_string_t **ret)
{
        int retval;
...
{
        requiem_list_t *tmp = (alertident_cur) ? &alertident_cur->list : NULL;

        requiem_return_val_if_fail(tool_alert, NULL);

        requiem_list_for_each_continue(&tool_alert->alertident_list, tmp)
                return requiem_list_entry(tmp, idmef_alertident_t, list);
...
int idmef_tool_alert_copy(const idmef_tool_alert_t *src, idmef_tool_alert_t *dst)
{
...

        {
                ...
                requiem_list_for_each_safe(&src->alertident_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_alertident_t, list);
                        idmef_alertident_clone(entry, &new);
                        requiem_list_add_tail(&dst->alertident_list, &new->list);
                }
        }
...
int idmef_tool_alert_compare(const idmef_tool_alert_t *obj1, const idmef_tool_alert_t *obj2)
{
...

        {
                ...
                do {
                        ...
                        requiem_list_for_each_continue(&obj1->alertident_list, tmp1) {
                                entry1 = requiem_list_entry(tmp1, idmef_alertident_t, list);
                                break;
                        }

                        requiem_list_for_each_continue(&obj2->alertident_list, tmp2) {
                                entry2 = requiem_list_entry(tmp2, idmef_alertident_t, list);
                                break;
                        }
...
{
        requiem_return_val_if_fail(correlation_alert, NULL);
...
int _idmef_correlation_alert_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        return idmef_correlation_alert_new_name(ptr, (requiem_string_t **) ret);
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_correlation_alert_get_name(idmef_correlation_alert_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_correlation_alert_set_name(idmef_correlation_alert_t *ptr, requiem_string_t *name)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_correlation_alert_new_name(idmef_correlation_alert_t *ptr, requiem_string_t **ret)
{
        int retval;
...
idmef_alertident_t *idmef_correlation_alert_get_next_alertident(idmef_correlation_alert_t *correlation_alert, idmef_alertident_t *alertident_cur)
{
        ...
        requiem_list_for_each_continue(&correlation_alert->alertident_list, tmp)
                return requiem_list_entry(tmp, idmef_alertident_t, list);
...
int idmef_overflow_alert_new(idmef_overflow_alert_t **ret)
{
        *ret = calloc(1, sizeof(**ret));
        ...
        {
                int retval = requiem_string_new(&(*ret)->program);
...
{
        requiem_return_val_if_fail(overflow_alert, NULL);
...
int _idmef_overflow_alert_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        return idmef_overflow_alert_new_program(ptr, (requiem_string_t **) ret);
...
int _idmef_overflow_alert_destroy_child(void *p, idmef_class_child_id_t child, int n)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        if ( ptr->program ) {
                                requiem_string_destroy(ptr->program);
                                ptr->program = NULL;
                        }
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_overflow_alert_get_program(idmef_overflow_alert_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_overflow_alert_t object.
 * @program: pointer to a #requiem_string_t object.
 *
...
void idmef_overflow_alert_set_program(idmef_overflow_alert_t *ptr, requiem_string_t *program)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_overflow_alert_new_program(idmef_overflow_alert_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->program ) {
                retval = requiem_string_new(&ptr->program);
                if ( retval < 0 )
                        return retval;
        }
...
int idmef_overflow_alert_copy(const idmef_overflow_alert_t *src, idmef_overflow_alert_t *dst)
{
        ...
        if ( src->program ) {
                ret = requiem_string_copy(src->program, dst->program);
                if ( ret < 0 )
                        return ret;
        }
...
int idmef_overflow_alert_compare(const idmef_overflow_alert_t *obj1, const idmef_overflow_alert_t *obj2)
{
        ...
        ret = requiem_string_compare(obj1->program, obj2->program);
        if ( ret != 0 )
                return ret;
...
int idmef_alert_new(idmef_alert_t **ret)
{
        *ret = calloc(1, sizeof(**ret));
        ...
        requiem_list_init(&(*ret)->analyzer_list);


        requiem_list_init(&(*ret)->source_list);


        requiem_list_init(&(*ret)->target_list);


        requiem_list_init(&(*ret)->additional_data_list);
...
{
        requiem_return_val_if_fail(alert, NULL);
        alert->refcount++;
...
int _idmef_alert_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        return idmef_alert_new_messageid(ptr, (requiem_string_t **) ret);
                ...
                case 1: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->analyzer_list, tmp) {
                                       if ( i++ == n ) {
                                               *ret = requiem_list_entry(tmp, idmef_analyzer_t, list);
                                               return 0;
                                       }
                               }
                               ...
                               requiem_list_for_each_reversed(&ptr->analyzer_list, tmp) {
                                       if ( i++ == pos ) {
                                               *ret = requiem_list_entry(tmp, idmef_analyzer_t, list);
                                               return 0;
                                       }
                ...
                case 6: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->source_list, tmp) {
                                       if ( i++ == n ) {
                                               *ret = requiem_list_entry(tmp, idmef_source_t, list);
                                               return 0;
                                       }
                               }
                               ...
                               requiem_list_for_each_reversed(&ptr->source_list, tmp) {
                                       if ( i++ == pos ) {
                                               *ret = requiem_list_entry(tmp, idmef_source_t, list);
                                               return 0;
                                       }
                ...
                case 7: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->target_list, tmp) {
                                       if ( i++ == n ) {
                                               *ret = requiem_list_entry(tmp, idmef_target_t, list);
                                               return 0;
                                       }
                               }
                               ...
                               requiem_list_for_each_reversed(&ptr->target_list, tmp) {
                                       if ( i++ == pos ) {
                                               *ret = requiem_list_entry(tmp, idmef_target_t, list);
                                               return 0;
                                       }
                ...
                case 9: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->additional_data_list, tmp) {
                                       if ( i++ == n ) {
                                               *ret = requiem_list_entry(tmp, idmef_additional_data_t, list);
                                               return 0;
                                       }
                               }
                               ...
                               requiem_list_for_each_reversed(&ptr->additional_data_list, tmp) {
                                       if ( i++ == pos ) {
                                               *ret = requiem_list_entry(tmp, idmef_additional_data_t, list);
                                               return 0;
                                       }
...
int _idmef_alert_destroy_child(void *p, idmef_class_child_id_t child, int n)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        if ( ptr->messageid ) {
                                requiem_string_destroy(ptr->messageid);
                                ptr->messageid = NULL;
                        }
                ...
                case 1: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->analyzer_list, tmp) {
                                       if ( i++ == n ) {
                                               void *b = requiem_list_entry(tmp, idmef_analyzer_t, list);
                ...
                case 6: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->source_list, tmp) {
                                       if ( i++ == n ) {
                                               void *b = requiem_list_entry(tmp, idmef_source_t, list);
                ...
                case 7: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->target_list, tmp) {
                                       if ( i++ == n ) {
                                               void *b = requiem_list_entry(tmp, idmef_target_t, list);
                ...
                case 9: {
                        ...
                        if ( n >= 0 ) {
                               requiem_list_for_each(&ptr->additional_data_list, tmp) {
                                       if ( i++ == n ) {
                                               void *b = requiem_list_entry(tmp, idmef_additional_data_t, list);
...
static void idmef_alert_destroy_internal(idmef_alert_t *ptr)
{
...

        {
                ...
                requiem_list_for_each_safe(&ptr->analyzer_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_analyzer_t, list);
                        requiem_list_del_init(&entry->list);
...

        {
                ...
                requiem_list_for_each_safe(&ptr->source_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_source_t, list);
                        requiem_list_del_init(&entry->list);
...

        {
                ...
                requiem_list_for_each_safe(&ptr->target_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_target_t, list);
                        requiem_list_del_init(&entry->list);
...

        {
                ...
                requiem_list_for_each_safe(&ptr->additional_data_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_additional_data_t, list);
                        requiem_list_del_init(&entry->list);
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_alert_get_messageid(idmef_alert_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
 ...
 * @ptr: pointer to a #idmef_alert_t object.
 * @messageid: pointer to a #requiem_string_t object.
 *
...
void idmef_alert_set_messageid(idmef_alert_t *ptr, requiem_string_t *messageid)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_alert_new_messageid(idmef_alert_t *ptr, requiem_string_t **ret)
{
        int retval;
        ...
        if ( ! ptr->messageid ) {
                retval = requiem_string_new(&ptr->messageid);
                if ( retval < 0 )
                        return retval;
        }
...
{
        requiem_list_t *tmp = (analyzer_cur) ? &analyzer_cur->list : NULL;

        requiem_return_val_if_fail(alert, NULL);

        requiem_list_for_each_continue(&alert->analyzer_list, tmp)
                return requiem_list_entry(tmp, idmef_analyzer_t, list);
...
{
        requiem_list_t *tmp = (source_cur) ? &source_cur->list : NULL;

        requiem_return_val_if_fail(alert, NULL);

        requiem_list_for_each_continue(&alert->source_list, tmp)
                return requiem_list_entry(tmp, idmef_source_t, list);
...
{
        requiem_list_t *tmp = (target_cur) ? &target_cur->list : NULL;

        requiem_return_val_if_fail(alert, NULL);

        requiem_list_for_each_continue(&alert->target_list, tmp)
                return requiem_list_entry(tmp, idmef_target_t, list);
...
{
        requiem_list_t *tmp = (additional_data_cur) ? &additional_data_cur->list : NULL;

        requiem_return_val_if_fail(alert, NULL);

        requiem_list_for_each_continue(&alert->additional_data_list, tmp)
                return requiem_list_entry(tmp, idmef_additional_data_t, list);
...
int idmef_alert_copy(const idmef_alert_t *src, idmef_alert_t *dst)
{
        ...
        if ( src->messageid ) {
                ret = requiem_string_clone(src->messageid, &dst->messageid);
                if ( ret < 0 )
                        return ret;
        }

        {
                ...
                requiem_list_for_each_safe(&src->analyzer_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_analyzer_t, list);
                        idmef_analyzer_clone(entry, &new);
                        requiem_list_add_tail(&dst->analyzer_list, &new->list);
                }
        }
...

        {
                ...
                requiem_list_for_each_safe(&src->source_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_source_t, list);
                        idmef_source_clone(entry, &new);
                        requiem_list_add_tail(&dst->source_list, &new->list);
                }
        }

        {
                ...
                requiem_list_for_each_safe(&src->target_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_target_t, list);
                        idmef_target_clone(entry, &new);
                        requiem_list_add_tail(&dst->target_list, &new->list);
                }
        }
...

        {
                ...
                requiem_list_for_each_safe(&src->additional_data_list, tmp, n) {
                        entry = requiem_list_entry(tmp, idmef_additional_data_t, list);
                        idmef_additional_data_clone(entry, &new);
                        requiem_list_add_tail(&dst->additional_data_list, &new->list);
                }
        }
...
int idmef_alert_compare(const idmef_alert_t *obj1, const idmef_alert_t *obj2)
{
        ...
        ret = requiem_string_compare(obj1->messageid, obj2->messageid);
        if ( ret != 0 )
                return ret;

        {
                ...
                do {
                        ...
                        requiem_list_for_each_continue(&obj1->analyzer_list, tmp1) {
                                entry1 = requiem_list_entry(tmp1, idmef_analyzer_t, list);
                                break;
                        }

                        requiem_list_for_each_continue(&obj2->analyzer_list, tmp2) {
                                entry2 = requiem_list_entry(tmp2, idmef_analyzer_t, list);
                                break;
                        }
...

        {
                ...
                do {
                        ...
                        requiem_list_for_each_continue(&obj1->source_list, tmp1) {
                                entry1 = requiem_list_entry(tmp1, idmef_source_t, list);
                                break;
                        }

                        requiem_list_for_each_continue(&obj2->source_list, tmp2) {
                                entry2 = requiem_list_entry(tmp2, idmef_source_t, list);
                                break;
                        }
...

        {
                ...
                do {
                        ...
                        requiem_list_for_each_continue(&obj1->target_list, tmp1) {
                                entry1 = requiem_list_entry(tmp1, idmef_target_t, list);
                                break;
                        }

                        requiem_list_for_each_continue(&obj2->target_list, tmp2) {
                                entry2 = requiem_list_entry(tmp2, idmef_target_t, list);
                                break;
                        }
...

        {
                ...
                do {
                        ...
                        requiem_list_for_each_continue(&obj1->additional_data_list, tmp1) {
                                entry1 = requiem_list_entry(tmp1, idmef_additional_data_t, list);
                                break;
                        }

                        requiem_list_for_each_continue(&obj2->additional_data_list, tmp2) {
                                entry2 = requiem_list_entry(tmp2, idmef_additional_data_t, list);
                                break;
                        }
...
{
        requiem_return_val_if_fail(heartbeat, NULL);
        heartbeat->refcount++;
...
int _idmef_heartbeat_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        return idmef_heartbeat_new_messageid(ptr, (requiem_string_t **) ret);
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_heartbeat_get_messageid(idmef_heartbeat_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_heartbeat_set_messageid(idmef_heartbeat_t *ptr, requiem_string_t *messageid)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_heartbeat_new_messageid(idmef_heartbeat_t *ptr, requiem_string_t **ret)
{
        int retval;
...
idmef_analyzer_t *idmef_heartbeat_get_next_analyzer(idmef_heartbeat_t *heartbeat, idmef_analyzer_t *analyzer_cur)
{
        ...
        requiem_list_for_each_continue(&heartbeat->analyzer_list, tmp)
                return requiem_list_entry(tmp, idmef_analyzer_t, list);
...
idmef_additional_data_t *idmef_heartbeat_get_next_additional_data(idmef_heartbeat_t *heartbeat, idmef_additional_data_t *additional_data_cur)
{
        ...
        requiem_list_for_each_continue(&heartbeat->additional_data_list, tmp)
                return requiem_list_entry(tmp, idmef_additional_data_t, list);
...
int idmef_message_new(idmef_message_t **ret)
{
        *ret = calloc(1, sizeof(**ret));
        ...
        {
                int retval = requiem_string_new(&(*ret)->version);
...
{
        requiem_return_val_if_fail(message, NULL);
        message->refcount++;
...
int _idmef_message_new_child(void *p, idmef_class_child_id_t child, int n, void **ret)
{
        ...
        switch ( child ) {
                ...
                case 0:
                        return idmef_message_new_version(ptr, (requiem_string_t **) ret);
 ...
 * Returns: a pointer to a requiem_string_t object, or NULL if the children object is not set.
 */
requiem_string_t *idmef_message_get_version(idmef_message_t *ptr)
{
        requiem_return_val_if_fail(ptr, 0); /* FIXME */
...
void idmef_message_set_version(idmef_message_t *ptr, requiem_string_t *version)
{
        requiem_return_if_fail(ptr);
 ...
 * Returns: 0 on success, or a negative value if an error occured.
 */
int idmef_message_new_version(idmef_message_t *ptr, requiem_string_t **ret)
{
        int retval;
...
int idmef_message_copy(const idmef_message_t *src, idmef_message_t *dst)
{
        ...
        if ( src->version ) {
                ret = requiem_string_copy(src->version, dst->version);
                if ( ret < 0 )
                        return ret;
        }
...
void idmef_message_set_pmsg(idmef_message_t *message, requiem_msg_t *msg)
{
        requiem_return_if_fail(message);
        message->pmsg = msg;
}


requiem_msg_t *idmef_message_get_pmsg(idmef_message_t *message)
{
        requiem_return_val_if_fail(message, NULL);
        return message->pmsg;
}
