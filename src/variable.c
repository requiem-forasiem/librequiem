...
static REQUIEM_LIST(variable_list);
...
static variable_t *search_entry(const char *variable)
{
        ...
        requiem_list_for_each(&variable_list, tmp) {
                item = requiem_list_entry(tmp, variable_t, list);
...
static int create_entry(const char *variable, const char *value)
{
        ...
        requiem_list_add_tail(&variable_list, &item->list);
...
void variable_unset_all(void)
{
        ...
        requiem_list_for_each_safe(&variable_list, tmp, bkp) {
                item = requiem_list_entry(tmp, variable_t, list);
                destroy_variable(item);
        }
}
