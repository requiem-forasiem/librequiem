	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			case IDMEF_MSG_ADDITIONAL_DATA_TYPE: {
                                ...
                                ret = requiem_extract_int32_safe(&tmp, buf, len);
                                if ( ret < 0 )
                                        return ret;
			...
			case IDMEF_MSG_ADDITIONAL_DATA_MEANING: {
                                requiem_string_t *tmp = NULL;

                                ret = requiem_extract_string_safe(&tmp, buf, len, msg);
                                if ( ret < 0 )
                                        return ret;
			...
			case IDMEF_MSG_ADDITIONAL_DATA_DATA: {
                                ...
                                ret = requiem_extract_data_safe(&tmp, buf, len, msg);
                                if ( ret < 0 )
                                        return ret;
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_additional_data_t: '%u'", tag);
		}
...
int idmef_reference_read(idmef_reference_t *reference, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_reference_t: '%u'", tag);
		}
...
int idmef_classification_read(idmef_classification_t *classification, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_classification_t: '%u'", tag);
		}
...
int idmef_user_id_read(idmef_user_id_t *user_id, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_user_id_t: '%u'", tag);
		}
...
int idmef_user_read(idmef_user_t *user, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_user_t: '%u'", tag);
		}
...
int idmef_address_read(idmef_address_t *address, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_address_t: '%u'", tag);
		}
...
int idmef_process_read(idmef_process_t *process, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_process_t: '%u'", tag);
		}
...
int idmef_web_service_read(idmef_web_service_t *web_service, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_web_service_t: '%u'", tag);
		}
...
int idmef_snmp_service_read(idmef_snmp_service_t *snmp_service, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_snmp_service_t: '%u'", tag);
		}
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			case IDMEF_MSG_SERVICE_PORT: {
                                ...
                                ret = requiem_extract_uint16_safe(&tmp, buf, len);
                                if ( ret < 0 )
                                        return ret;
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_service_t: '%u'", tag);
		}
...
int idmef_node_read(idmef_node_t *node, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_node_t: '%u'", tag);
		}
...
int idmef_source_read(idmef_source_t *source, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_source_t: '%u'", tag);
		}
...
int idmef_file_access_read(idmef_file_access_t *file_access, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_file_access_t: '%u'", tag);
		}
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			case IDMEF_MSG_INODE_CHANGE_TIME: {
                                ...
                                ret = requiem_extract_time_safe(&tmp, buf, len, msg);
                                if ( ret < 0 )
                                        return ret;
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_inode_t: '%u'", tag);
		}
...
int idmef_checksum_read(idmef_checksum_t *checksum, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_checksum_t: '%u'", tag);
		}
...
int idmef_file_read(idmef_file_t *file, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_file_t: '%u'", tag);
		}
...
int idmef_linkage_read(idmef_linkage_t *linkage, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_linkage_t: '%u'", tag);
		}
...
int idmef_target_read(idmef_target_t *target, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_target_t: '%u'", tag);
		}
...
int idmef_analyzer_read(idmef_analyzer_t *analyzer, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_analyzer_t: '%u'", tag);
		}
...
int idmef_alertident_read(idmef_alertident_t *alertident, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_alertident_t: '%u'", tag);
		}
...
int idmef_impact_read(idmef_impact_t *impact, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_impact_t: '%u'", tag);
		}
...
int idmef_action_read(idmef_action_t *action, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_action_t: '%u'", tag);
		}
...
int idmef_confidence_read(idmef_confidence_t *confidence, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_confidence_t: '%u'", tag);
		}
...
int idmef_assessment_read(idmef_assessment_t *assessment, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_assessment_t: '%u'", tag);
		}
...
int idmef_tool_alert_read(idmef_tool_alert_t *tool_alert, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_tool_alert_t: '%u'", tag);
		}
...
int idmef_correlation_alert_read(idmef_correlation_alert_t *correlation_alert, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_correlation_alert_t: '%u'", tag);
		}
...
int idmef_overflow_alert_read(idmef_overflow_alert_t *overflow_alert, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_overflow_alert_t: '%u'", tag);
		}
...
int idmef_alert_read(idmef_alert_t *alert, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_alert_t: '%u'", tag);
		}
...
int idmef_heartbeat_read(idmef_heartbeat_t *heartbeat, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_heartbeat_t: '%u'", tag);
		}
...
int idmef_message_read(idmef_message_t *message, requiem_msg_t *msg)
{
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			default:
				return requiem_error_verbose(REQUIEM_ERROR_IDMEF_UNKNOWN_TAG, "Unknown tag while reading idmef_message_t: '%u'", tag);
		}
