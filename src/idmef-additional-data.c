...
static const struct {
        ...
        { IDMEF_ADDITIONAL_DATA_TYPE_BOOLEAN, IDMEF_DATA_TYPE_BYTE, sizeof(requiem_bool_t) },
...
IDMEF_ADDITIONAL_DATA_SIMPLE(IDMEF_DATA_TYPE_BYTE, byte, IDMEF_ADDITIONAL_DATA_TYPE_BOOLEAN, requiem_bool_t, boolean)
...
int idmef_additional_data_copy_ref(idmef_additional_data_t *src, idmef_additional_data_t *dst)
{
        ...
        ret = requiem_string_copy_ref(idmef_additional_data_get_meaning(src), idmef_additional_data_get_meaning(dst));
        if ( ret < 0 )
                return ret;
...
requiem_bool_t idmef_additional_data_is_empty(idmef_additional_data_t *data)
{
...
int idmef_additional_data_data_to_string(idmef_additional_data_t *ad, requiem_string_t *out)
{
        int ret;
        uint64_t i;
        idmef_data_t *data;
        ...
        case IDMEF_ADDITIONAL_DATA_TYPE_NTPSTAMP:
                ...
                ret = requiem_string_sprintf(out, "0x%08lux.0x%08lux", (unsigned long) (i >> 32), (unsigned long) i);
                break;
