...
static uint64_t get_current_time(requiem_ident_t *ident)
{
        uint64_t now;
...
static void uuidgen(requiem_ident_t *ident)
{
        uint64_t timestamp;
 ...
 *
 * Create a new #requiem_ident_t object with an unique value.
 *
...
/**
 * requiem_ident_generate:
 * @ident: Pointer to a #requiem_ident_t object.
 * @out: #requiem_string_t where the ident will be generated.
 *
...
int requiem_ident_generate(requiem_ident_t *ident, requiem_string_t *out)
{
        ...
        return requiem_string_sprintf(out, "%8.8x-%4.4x-%4.4x-%2.2x%2.2x",
...
/**
 * requiem_ident_destroy:
 * @ident: Pointer to a #requiem_ident_t object.
 *
 * Destroy a #requiem_ident_t object.
 */
