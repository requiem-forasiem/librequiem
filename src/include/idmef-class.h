...
#ifndef _LIBREQUIEM_IDMEF_CLASS_H
#define _LIBREQUIEM_IDMEF_CLASS_H
 ...
 *
 */
requiem_bool_t idmef_class_is_child_list(idmef_class_id_t classid, idmef_class_child_id_t child);
...
#endif /* _LIBREQUIEM_IDMEF_CLASS_H */
