...
#ifndef _LIBREQUIEM_TLS_UTIL_H
#define _LIBREQUIEM_TLS_UTIL_H
...
int tls_certificate_get_permission(gnutls_session session, requiem_connection_permission_t *permission);

int _requiem_tls_crt_list_import(gnutls_x509_crt *certs, unsigned int *cmax,
