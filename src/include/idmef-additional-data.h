...
#ifndef _LIBREQUIEM_IDMEF_ADDITIONAL_DATA_H
#define _LIBREQUIEM_IDMEF_ADDITIONAL_DATA_H
...
int idmef_additional_data_new_boolean(idmef_additional_data_t **ret, requiem_bool_t data);
...
void idmef_additional_data_set_boolean(idmef_additional_data_t *ptr, requiem_bool_t data);
...
requiem_bool_t idmef_additional_data_get_boolean(idmef_additional_data_t *data);
...
#endif /* _LIBREQUIEM_IDMEF_DATA_H */
