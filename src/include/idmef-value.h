...
#ifndef _LIBREQUIEM_IDMEF_VALUE_H
#define _LIBREQUIEM_IDMEF_VALUE_H
...
int idmef_value_new_string(idmef_value_t **value, requiem_string_t *string);
...
int idmef_value_set_string(idmef_value_t *value, requiem_string_t *string);
...
requiem_string_t *idmef_value_get_string(const idmef_value_t *val);
...
#endif /* _LIBREQUIEM_IDMEF_VALUE_H */
