...
#ifndef _LIBREQUIEM_IDMEF_CRITERION_VALUE_H
#define _LIBREQUIEM_IDMEF_CRITERION_VALUE_H
...
int idmef_criterion_value_print(idmef_criterion_value_t *value, requiem_io_t *fd);

int idmef_criterion_value_to_string(idmef_criterion_value_t *value, requiem_string_t *out);
...
#endif /* _LIBREQUIEM_IDMEF_CRITERION_VALUE_H */
