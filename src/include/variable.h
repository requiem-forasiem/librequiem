...
*
* Written by Yoann Vandoorselaere <yoannv@gmail.com>
*
*****/

#ifndef _LIBREQUIEM_RULES_VARIABLE_H
#define _LIBREQUIEM_RULES_VARIABLE_H
...
#endif /* _LIBREQUIEM_RULES_VARIABLE_H */
