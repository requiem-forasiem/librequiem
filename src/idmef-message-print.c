 ...
 */
void idmef_additional_data_print(idmef_additional_data_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
...

        {
                ...
                {
                        print_indent(fd);
                        requiem_io_write(fd, "type: ", sizeof("type: ") - 1);
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_reference_print(idmef_reference_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
...

        {
                ...
                {
                        print_indent(fd);
                        requiem_io_write(fd, "origin: ", sizeof("origin: ") - 1);
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_classification_print(idmef_classification_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_user_id_print(idmef_user_id_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_user_print(idmef_user_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
...

        {
                ...
                {
                        print_indent(fd);
                        requiem_io_write(fd, "category: ", sizeof("category: ") - 1);
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_address_print(idmef_address_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_process_print(idmef_process_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_web_service_print(idmef_web_service_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_snmp_service_print(idmef_snmp_service_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_service_print(idmef_service_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_node_print(idmef_node_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_source_print(idmef_source_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
...

        {
                ...
                {
                        print_indent(fd);
                        requiem_io_write(fd, "spoofed: ", sizeof("spoofed: ") - 1);
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_file_access_print(idmef_file_access_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_inode_print(idmef_inode_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_checksum_print(idmef_checksum_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
...

        {
                ...
                {
                        print_indent(fd);
                        requiem_io_write(fd, "algorithm: ", sizeof("algorithm: ") - 1);
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_file_print(idmef_file_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
...

        {
                ...
                {
                        print_indent(fd);
                        requiem_io_write(fd, "fstype: ", sizeof("fstype: ") - 1);
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_linkage_print(idmef_linkage_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_target_print(idmef_target_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
...

        {
                ...
                {
                        print_indent(fd);
                        requiem_io_write(fd, "decoy: ", sizeof("decoy: ") - 1);
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_analyzer_print(idmef_analyzer_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_alertident_print(idmef_alertident_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_impact_print(idmef_impact_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
...

        {
                ...
                {
                        print_indent(fd);
                        requiem_io_write(fd, "severity: ", sizeof("severity: ") - 1);
...

        {
                ...
                {
                        print_indent(fd);
                        requiem_io_write(fd, "completion: ", sizeof("completion: ") - 1);
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_action_print(idmef_action_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_confidence_print(idmef_confidence_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
...

        {
                ...
                {
                        print_indent(fd);
                        requiem_io_write(fd, "rating: ", sizeof("rating: ") - 1);
        ...
        print_indent(fd);
        requiem_io_write(fd, "confidence: ", sizeof("confidence: ") - 1);
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_assessment_print(idmef_assessment_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
...

        {
                ...
                if ( field ) {
                        print_indent(fd);
                        requiem_io_write(fd, "confidence:\n", sizeof("confidence:\n") - 1);
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_tool_alert_print(idmef_tool_alert_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_correlation_alert_print(idmef_correlation_alert_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_overflow_alert_print(idmef_overflow_alert_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_alert_print(idmef_alert_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
...

        {
                ...
                if ( field ) {
                        print_indent(fd);
                        requiem_io_write(fd, "classification:\n", sizeof("classification:\n") - 1);
...

        {
                ...
                if ( field ) {
                        print_indent(fd);
                        requiem_io_write(fd, "assessment:\n", sizeof("assessment:\n") - 1);
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_heartbeat_print(idmef_heartbeat_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
 ...
 * and write it to the provided @fd descriptor.
 */
void idmef_message_print(idmef_message_t *ptr, requiem_io_t *fd)
{
        if ( ! ptr )
                return;
