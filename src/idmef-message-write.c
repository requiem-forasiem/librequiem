...
int idmef_additional_data_write(idmef_additional_data_t *additional_data, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_ADDITIONAL_DATA_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ...
        ret = requiem_string_write(idmef_additional_data_get_meaning(additional_data), msg, IDMEF_MSG_ADDITIONAL_DATA_MEANING);
        if ( ret < 0 )
                return ret;
        ...
        return requiem_msgbuf_set(msg, IDMEF_MSG_END_OF_TAG, 0, NULL);
}
...
int idmef_reference_write(idmef_reference_t *reference, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_REFERENCE_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ...
        ret = requiem_string_write(idmef_reference_get_name(reference), msg, IDMEF_MSG_REFERENCE_NAME);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_reference_get_url(reference), msg, IDMEF_MSG_REFERENCE_URL);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_reference_get_meaning(reference), msg, IDMEF_MSG_REFERENCE_MEANING);
        if ( ret < 0 )
                return ret;
...
int idmef_classification_write(idmef_classification_t *classification, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_CLASSIFICATION_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ret = requiem_string_write(idmef_classification_get_ident(classification), msg, IDMEF_MSG_CLASSIFICATION_IDENT);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_classification_get_text(classification), msg, IDMEF_MSG_CLASSIFICATION_TEXT);
        if ( ret < 0 )
                return ret;
...
int idmef_user_id_write(idmef_user_id_t *user_id, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_USER_ID_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ret = requiem_string_write(idmef_user_id_get_ident(user_id), msg, IDMEF_MSG_USER_ID_IDENT);
        if ( ret < 0 )
                return ret;
        ...
        ret = requiem_string_write(idmef_user_id_get_tty(user_id), msg, IDMEF_MSG_USER_ID_TTY);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_user_id_get_name(user_id), msg, IDMEF_MSG_USER_ID_NAME);
        if ( ret < 0 )
                return ret;
...
int idmef_user_write(idmef_user_t *user, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_USER_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ret = requiem_string_write(idmef_user_get_ident(user), msg, IDMEF_MSG_USER_IDENT);
        if ( ret < 0 )
                return ret;
...
int idmef_address_write(idmef_address_t *address, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_ADDRESS_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ret = requiem_string_write(idmef_address_get_ident(address), msg, IDMEF_MSG_ADDRESS_IDENT);
        if ( ret < 0 )
                return ret;
        ...
        ret = requiem_string_write(idmef_address_get_vlan_name(address), msg, IDMEF_MSG_ADDRESS_VLAN_NAME);
        if ( ret < 0 )
                return ret;
        ...
        ret = requiem_string_write(idmef_address_get_address(address), msg, IDMEF_MSG_ADDRESS_ADDRESS);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_address_get_netmask(address), msg, IDMEF_MSG_ADDRESS_NETMASK);
        if ( ret < 0 )
                return ret;
...
int idmef_process_write(idmef_process_t *process, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_PROCESS_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ret = requiem_string_write(idmef_process_get_ident(process), msg, IDMEF_MSG_PROCESS_IDENT);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_process_get_name(process), msg, IDMEF_MSG_PROCESS_NAME);
        if ( ret < 0 )
                return ret;
        ...
        ret = requiem_string_write(idmef_process_get_path(process), msg, IDMEF_MSG_PROCESS_PATH);
        if ( ret < 0 )
                return ret;


        {
                requiem_string_t *arg = NULL;

                while ( (arg = idmef_process_get_next_arg(process, arg)) ) {
                        ret = requiem_string_write(arg, msg, IDMEF_MSG_PROCESS_ARG);
                        if ( ret < 0 )
                                return ret;
                }
        }
        ...
        {
                requiem_string_t *env = NULL;

                while ( (env = idmef_process_get_next_env(process, env)) ) {
                        ret = requiem_string_write(env, msg, IDMEF_MSG_PROCESS_ENV);
                        if ( ret < 0 )
                                return ret;
                }
        }
...
int idmef_web_service_write(idmef_web_service_t *web_service, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_WEB_SERVICE_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ret = requiem_string_write(idmef_web_service_get_url(web_service), msg, IDMEF_MSG_WEB_SERVICE_URL);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_web_service_get_cgi(web_service), msg, IDMEF_MSG_WEB_SERVICE_CGI);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_web_service_get_http_method(web_service), msg, IDMEF_MSG_WEB_SERVICE_HTTP_METHOD);
        if ( ret < 0 )
                return ret;
...

        {
                ...
                while ( (arg = idmef_web_service_get_next_arg(web_service, arg)) ) {
                        ret = requiem_string_write(arg, msg, IDMEF_MSG_WEB_SERVICE_ARG);
                        if ( ret < 0 )
                                return ret;
                }
        }
...
int idmef_snmp_service_write(idmef_snmp_service_t *snmp_service, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_SNMP_SERVICE_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ret = requiem_string_write(idmef_snmp_service_get_oid(snmp_service), msg, IDMEF_MSG_SNMP_SERVICE_OID);
        if ( ret < 0 )
                return ret;
        ...
        ret = requiem_string_write(idmef_snmp_service_get_security_name(snmp_service), msg, IDMEF_MSG_SNMP_SERVICE_SECURITY_NAME);
        if ( ret < 0 )
                return ret;
        ...
        ret = requiem_string_write(idmef_snmp_service_get_context_name(snmp_service), msg, IDMEF_MSG_SNMP_SERVICE_CONTEXT_NAME);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_snmp_service_get_context_engine_id(snmp_service), msg, IDMEF_MSG_SNMP_SERVICE_CONTEXT_ENGINE_ID);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_snmp_service_get_command(snmp_service), msg, IDMEF_MSG_SNMP_SERVICE_COMMAND);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_snmp_service_get_community(snmp_service), msg, IDMEF_MSG_SNMP_SERVICE_COMMUNITY);
        if ( ret < 0 )
                return ret;
...
int idmef_service_write(idmef_service_t *service, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_SERVICE_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ret = requiem_string_write(idmef_service_get_ident(service), msg, IDMEF_MSG_SERVICE_IDENT);
        if ( ret < 0 )
                return ret;
        ...
        ret = requiem_string_write(idmef_service_get_iana_protocol_name(service), msg, IDMEF_MSG_SERVICE_IANA_PROTOCOL_NAME);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_service_get_name(service), msg, IDMEF_MSG_SERVICE_NAME);
        if ( ret < 0 )
                return ret;
        ...
        ret = requiem_string_write(idmef_service_get_portlist(service), msg, IDMEF_MSG_SERVICE_PORTLIST);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_service_get_protocol(service), msg, IDMEF_MSG_SERVICE_PROTOCOL);
        if ( ret < 0 )
                return ret;
...
int idmef_node_write(idmef_node_t *node, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_NODE_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ret = requiem_string_write(idmef_node_get_ident(node), msg, IDMEF_MSG_NODE_IDENT);
        if ( ret < 0 )
                return ret;
        ...
        ret = requiem_string_write(idmef_node_get_location(node), msg, IDMEF_MSG_NODE_LOCATION);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_node_get_name(node), msg, IDMEF_MSG_NODE_NAME);
        if ( ret < 0 )
                return ret;
...
int idmef_source_write(idmef_source_t *source, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_SOURCE_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ret = requiem_string_write(idmef_source_get_ident(source), msg, IDMEF_MSG_SOURCE_IDENT);
        if ( ret < 0 )
                return ret;
        ...
        ret = requiem_string_write(idmef_source_get_interface(source), msg, IDMEF_MSG_SOURCE_INTERFACE);
        if ( ret < 0 )
                return ret;
...
int idmef_file_access_write(idmef_file_access_t *file_access, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_FILE_ACCESS_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ...
        {
                requiem_string_t *permission = NULL;

                while ( (permission = idmef_file_access_get_next_permission(file_access, permission)) ) {
                        ret = requiem_string_write(permission, msg, IDMEF_MSG_FILE_ACCESS_PERMISSION);
                        if ( ret < 0 )
                                return ret;
                }
        }
...
int idmef_inode_write(idmef_inode_t *inode, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_INODE_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
...
int idmef_linkage_write(idmef_linkage_t *, requiem_msgbuf_t *);
...
int idmef_checksum_write(idmef_checksum_t *checksum, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_CHECKSUM_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ret = requiem_string_write(idmef_checksum_get_value(checksum), msg, IDMEF_MSG_CHECKSUM_VALUE);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_checksum_get_key(checksum), msg, IDMEF_MSG_CHECKSUM_KEY);
        if ( ret < 0 )
                return ret;
...
int idmef_file_write(idmef_file_t *file, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_FILE_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ret = requiem_string_write(idmef_file_get_ident(file), msg, IDMEF_MSG_FILE_IDENT);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_file_get_name(file), msg, IDMEF_MSG_FILE_NAME);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_file_get_path(file), msg, IDMEF_MSG_FILE_PATH);
        if ( ret < 0 )
                return ret;
        ...
        ret = requiem_string_write(idmef_file_get_file_type(file), msg, IDMEF_MSG_FILE_FILE_TYPE);
        if ( ret < 0 )
                return ret;
...
int idmef_linkage_write(idmef_linkage_t *linkage, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_LINKAGE_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ...
        ret = requiem_string_write(idmef_linkage_get_name(linkage), msg, IDMEF_MSG_LINKAGE_NAME);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_linkage_get_path(linkage), msg, IDMEF_MSG_LINKAGE_PATH);
        if ( ret < 0 )
                return ret;
...
int idmef_target_write(idmef_target_t *target, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_TARGET_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ret = requiem_string_write(idmef_target_get_ident(target), msg, IDMEF_MSG_TARGET_IDENT);
        if ( ret < 0 )
                return ret;
        ...
        ret = requiem_string_write(idmef_target_get_interface(target), msg, IDMEF_MSG_TARGET_INTERFACE);
        if ( ret < 0 )
                return ret;
...
int idmef_analyzer_write(idmef_analyzer_t *analyzer, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_ANALYZER_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ret = requiem_string_write(idmef_analyzer_get_analyzerid(analyzer), msg, IDMEF_MSG_ANALYZER_ANALYZERID);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_analyzer_get_name(analyzer), msg, IDMEF_MSG_ANALYZER_NAME);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_analyzer_get_manufacturer(analyzer), msg, IDMEF_MSG_ANALYZER_MANUFACTURER);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_analyzer_get_model(analyzer), msg, IDMEF_MSG_ANALYZER_MODEL);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_analyzer_get_version(analyzer), msg, IDMEF_MSG_ANALYZER_VERSION);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_analyzer_get_class(analyzer), msg, IDMEF_MSG_ANALYZER_CLASS);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_analyzer_get_ostype(analyzer), msg, IDMEF_MSG_ANALYZER_OSTYPE);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_analyzer_get_osversion(analyzer), msg, IDMEF_MSG_ANALYZER_OSVERSION);
        if ( ret < 0 )
                return ret;
...
int idmef_alertident_write(idmef_alertident_t *alertident, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_ALERTIDENT_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ret = requiem_string_write(idmef_alertident_get_alertident(alertident), msg, IDMEF_MSG_ALERTIDENT_ALERTIDENT);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_alertident_get_analyzerid(alertident), msg, IDMEF_MSG_ALERTIDENT_ANALYZERID);
        if ( ret < 0 )
                return ret;
...
int idmef_impact_write(idmef_impact_t *impact, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_IMPACT_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ...
        ret = requiem_string_write(idmef_impact_get_description(impact), msg, IDMEF_MSG_IMPACT_DESCRIPTION);
        if ( ret < 0 )
                return ret;
...
int idmef_action_write(idmef_action_t *action, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_ACTION_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ...
        ret = requiem_string_write(idmef_action_get_description(action), msg, IDMEF_MSG_ACTION_DESCRIPTION);
        if ( ret < 0 )
                return ret;
...
int idmef_confidence_write(idmef_confidence_t *confidence, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_CONFIDENCE_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
...
int idmef_assessment_write(idmef_assessment_t *assessment, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_ASSESSMENT_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
...
int idmef_tool_alert_write(idmef_tool_alert_t *tool_alert, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_TOOL_ALERT_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ret = requiem_string_write(idmef_tool_alert_get_name(tool_alert), msg, IDMEF_MSG_TOOL_ALERT_NAME);
        if ( ret < 0 )
                return ret;

        ret = requiem_string_write(idmef_tool_alert_get_command(tool_alert), msg, IDMEF_MSG_TOOL_ALERT_COMMAND);
        if ( ret < 0 )
                return ret;
...
int idmef_correlation_alert_write(idmef_correlation_alert_t *correlation_alert, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_CORRELATION_ALERT_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ret = requiem_string_write(idmef_correlation_alert_get_name(correlation_alert), msg, IDMEF_MSG_CORRELATION_ALERT_NAME);
        if ( ret < 0 )
                return ret;
...
int idmef_overflow_alert_write(idmef_overflow_alert_t *overflow_alert, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_OVERFLOW_ALERT_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ret = requiem_string_write(idmef_overflow_alert_get_program(overflow_alert), msg, IDMEF_MSG_OVERFLOW_ALERT_PROGRAM);
        if ( ret < 0 )
                return ret;
...
int idmef_alert_write(idmef_alert_t *alert, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_msgbuf_set(msg, IDMEF_MSG_ALERT_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ret = requiem_string_write(idmef_alert_get_messageid(alert), msg, IDMEF_MSG_ALERT_MESSAGEID);
        if ( ret < 0 )
                return ret;
...
int idmef_heartbeat_write(idmef_heartbeat_t *heartbeat, requiem_msgbuf_t *msg)
{
        ...
        requiem_msg_set_priority(requiem_msgbuf_get_msg(msg), REQUIEM_MSG_PRIORITY_HIGH);

        ret = requiem_msgbuf_set(msg, IDMEF_MSG_HEARTBEAT_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;
        ret = requiem_string_write(idmef_heartbeat_get_messageid(heartbeat), msg, IDMEF_MSG_HEARTBEAT_MESSAGEID);
        if ( ret < 0 )
                return ret;
...
int idmef_message_write(idmef_message_t *message, requiem_msgbuf_t *msg)
{
        ...
        ret = requiem_string_write(idmef_message_get_version(message), msg, IDMEF_MSG_MESSAGE_VERSION);
        if ( ret < 0 )
                return ret;
