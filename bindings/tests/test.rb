...
RequiemEasy::Requiem.og::SetCallback(lambda{|level,str|print "log: " + str})
idmef = RequiemEasy::IDMEF.new()
...
print "\n*** Client ***\n"
c = RequiemEasy::ClientEasy.new("requiem-lml")
c.Start()
