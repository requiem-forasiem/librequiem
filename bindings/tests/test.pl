...
RequiemEasy::Requiem.og::SetCallback(\&log_func);

$idmef = new RequiemEasy::IDMEF;
$client = new RequiemEasy::ClientEasy("abc");
$client->Start();
...
my $idmef2 = new RequiemEasy::IDMEF;
$idmef2->Read(FILE2);
close FILE2;
print $idmef2->ToString();

print "\n*** Client ***";
$client = new RequiemEasy::ClientEasy("requiem-lml");
$client->Start();
